...
Begin VB.Form CXM1150_ 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin vsFlexLib.vsFlexArray VsGrid1 
         ...
         Appearance      =   1
         ConvInfo        =   1413783674
         FormatString    =   "No |レベル|区|XXXXXXXXX1XXXXXXXXX2XXXXX|XXXXXXXXX1XXXXXXXXX2|使用数|展開区分  |9999/99/99-9999/99/99|寸法|検索元品番|"
         Rows            =   20
         Cols            =   12
         BackColor       =   12648447
         BackColorBkg    =   12632256
...
'                      ｾﾙ桁数,列番号,見出し内容,分類ﾀｲﾌﾟ)
      ''ReDim SCol(11)                                              ' 2019/07/18 DEL
        ReDim SCol(11)                                              ' 2019/07/18 ADD
        ...
        Call .FixedSet(中中, 左中, あり, 25, 10, "検索元品番")      ' 2019/07/18 ADD
'　ｸﾞﾘｯﾄﾞ選択処理用　退避ｴﾘｱ
      ''Call .FixedSet(中中, 左中, あり, 0, 10, "Select")
        Call .FixedSet(中中, 左中, あり, 0, 11, "Select")
'  表示ﾊﾟﾀｰﾝｾｯﾄ
'       Call .PatanSet(ﾊﾟﾀｰﾝNO,表示パターン)
        Call .PatanSet(0, "0,1,2,9,3,8,4,5,6,7")
        Call .PatanSet(1, "0,9,3,4")
...
'        Call .EditSet(iH_Text1, 1)
        ...
        SCol(10) = .FixedGet(10)   ' 検索元品番                     ' 2019/07/18 ADD
    End With
  ''KCol = 9   ' 非表示項目開始ｶﾗﾑ                                  ' 2019/07/18 DEL
    KCol = 10  ' 非表示項目開始ｶﾗﾑ                                  ' 2019/07/18 ADD
