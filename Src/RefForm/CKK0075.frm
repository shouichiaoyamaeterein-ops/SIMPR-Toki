...
Begin VB.Form CKK0075 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CKK0075.frx":0000
         Height          =   5280
         Left            =   60
         OleObjectBlob   =   "CKK0075.frx":0015
         TabIndex        =   1
         Top             =   60
         Width           =   7395
      End
...
Private Function BodySet() As Boolean
    BodySet = False
    gSL_Select = "SELECT ZR.材質,ZR.寸法区分,MAX(材料名) 材料名,"
    gSL_Select = gSL_Select & " CASE WHEN ZR.寸法区分 = 0 "
    gSL_Select = gSL_Select & "     THEN '' ELSE '無' END 寸法区分名 "
    gSL_Select = gSL_Select & " FROM 材料マスタ ZR"
    mSL_OrderA = " GROUP BY ZR.材質,ZR.寸法区分"
    mSL_OrderA = mSL_OrderA & " Order By ZR.材質"
    mSL_OrderD = " GROUP BY ZR.材質,ZR.寸法区分"
    mSL_OrderD = mSL_OrderD & " Order By 材質 DESC"
' 選択条件セット
    mSL_SelectW = ""
    With CisFun
        .Where_CreateKB = NewDocument
        .Where_Create AlphaMe, "材質", iH1_Zaist
