...
Begin VB.Form CXH0045 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CXH0045.frx":0000
         Height          =   5580
         Left            =   90
         OleObjectBlob   =   "CXH0045.frx":0015
         TabIndex        =   6
         Top             =   60
         Width           =   9045
      End
...
Private Function BodySet() As Boolean
    ...
    BodySet = False
    gSL_Select = "SELECT NH.手配先,NH.受入,NH.品番,"
    ...
    gSL_Select = gSL_Select & "     HN.表示品番,ISNULL(TR.略称,'') 手配先名"
    ...
    mSL_OrderA = " Order By NH.手配先,NH.受入,NH.品番 "
    mSL_OrderD = " Order By NH.手配先 Desc,NH.受入 Desc,NH.品番 Desc"
' 選択条件セット
    mSL_SelectW = ""
    With CisFun
    ...
    End With
    mSL_SelectW = mSL_SelectW & " GROUP BY NH.手配先,NH.受入,NH.品番,NC.発注処理日,HN.表示品番,TR.略称"
