...
Begin VB.Form CKNK0100 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CKNK0100.frx":0000
         Height          =   5550
         Left            =   90
         OleObjectBlob   =   "CKNK0100.frx":0015
         TabIndex        =   5
         Top             =   60
         Width           =   6195
      End
...
Private Function BodySet() As Boolean
    ...
    BodySet = False
    gSL_Select = "SELECT HC.仕入先,TR.略称,HC.受入,HC.サイクル,"
    gSL_Select = gSL_Select & "SUBSTRING(HC.サイクル,1,1) + '-' + "
    gSL_Select = gSL_Select & "SUBSTRING(HC.サイクル,2,2) + '-' + "
    gSL_Select = gSL_Select & "SUBSTRING(HC.サイクル,4,2) 編集サイクル "
    ...
    mSL_Group = " GROUP By HC.仕入先,HC.受入,HC.サイクル,TR.略称"
    mSL_OrderA = " Order By HC.仕入先,HC.受入 ,HC.サイクル"
    mSL_OrderD = " Order By HC.仕入先 Desc,HC.受入 Desc,HC.サイクル desc"
' 選択条件セット
    mSL_SelectW = ""
    With CisFun
        .Where_CreateKB = NewDocument
        .Where_Create AlphaMe, "HC.仕入先", iH1_Torcd
        .Where_Create AlphaMe, "HC.受入", iH1_Ukeir
        .Where_Create AlphaMe, "HC.サイクル", iH1_Cycle1 & iH1_Cycle2 & iH1_Cycle3
