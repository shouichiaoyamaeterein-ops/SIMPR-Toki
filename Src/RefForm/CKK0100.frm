...
Begin VB.Form CKK0100 
   ...
   Begin VB.PictureBox H1_Area1 
      ...
      Begin Cis3D_v60.CIS3D UC_3D 
         ...
         Begin Cis3D_v60.CIS3D UC_3D2 
            ...
            cFont3DColor2   =   8421504
            cAlingnment     =   6
            Begin CisText_V60.CisText iH1_THinbn 
               Height          =   375
               Left            =   135
               TabIndex        =   1
               Top             =   330
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CKK0100.frx":0000
         Height          =   5565
         Left            =   90
         OleObjectBlob   =   "CKK0100.frx":0015
         TabIndex        =   4
         Top             =   60
         Width           =   10965
      End
...
Private Sub iH1_Torcd_LostFocus()
    ...
    End If
    H1lb_Tornm = ""
    If TorNmGet(iH1_Torcd, 4, 1) Then
...
Private Function BodySet() As Boolean
    BodySet = False
    gSL_Select = "SELECT 品番,得意先品番, "
    gSL_Select = gSL_Select & "    CASE WHEN ISNULL(TR.略称,'') = '' Then 納入先"
    gSL_Select = gSL_Select & "     Else 納入先 + ':' + RTRIM(略称)    End 表示納入先,"
    gSL_Select = gSL_Select & "    受入 , 納入先"
    gSL_Select = gSL_Select & "     FROM 品番置換マスタ HR"
    gSL_Select = gSL_Select & "    Left Outer Join 取引先マスタ TR"
    gSL_Select = gSL_Select & "    On TR.取引先CD = HR.納入先"
    mSL_OrderA = " Order By 品番,得意先品番,納入先,受入 "
    mSL_OrderD = " Order By 品番 Desc,得意先品番 Desc,納入先 Desc,受入 Desc"
' 選択条件セット
    mSL_SelectW = ""
    With CisFun
        .Where_CreateKB = NewDocument
        .Where_Create AlphaMe, "品番", iH1_Hinbn
        .Where_Create AlphaMe, "得意先品番", iH1_THinbn
