...
Begin VB.Form COK0935 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "COK0935.frx":0000
         Height          =   5565
         Left            =   45
         OleObjectBlob   =   "COK0935.frx":0015
         TabIndex        =   3
         Top             =   60
         Width           =   14190
      End
...
Private Function BodySet() As Boolean
    ...
    gSL_Select = gSL_Select & "KJ.数量,KJ.単価,KJ.金額,KJ.識別子,KJ.仕入先,KJ.検収管理NO,  "
