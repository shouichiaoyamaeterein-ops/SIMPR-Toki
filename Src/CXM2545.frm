...
Begin VB.Form CXM2545 
   BorderStyle     =   1  '固定(実線)
   Caption         =   "支払先スクラップ単価 印刷"
   ClientHeight    =   2625
   ClientLeft      =   6270
   ClientTop       =   5850
   ClientWidth     =   5265
...
'   出力先
    lb_msg.Caption = "【 支払先スクラップ単価 印刷中 】"
    DoEvents
    With CisPrtCXM2540
         Set .iPrtForm = CXM2540L
         .dpMSG = "支払先スクラップ単価　印刷中"
