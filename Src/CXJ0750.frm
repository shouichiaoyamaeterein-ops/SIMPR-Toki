...
Begin VB.Form CXJ0750 
   BackColor       =   &H00808000&
   BorderStyle     =   1  '固定(実線)
   Caption         =   "【ヨロズ愛知】受注データ変換"
   ClientHeight    =   11190
   ClientLeft      =   150
   ClientTop       =   1290
   ClientWidth     =   15360
...
Private Function ZenProc_Get()
    ...
    Call ItemsClearSYM
    gSL_Select = "Select * From 名称マスタ "
    gSL_Select = gSL_Select & " Where 区分名称   = 'テキスト管理[ヨロズ愛知]'"
    gSL_Select = gSL_Select & " And   区分タイプ = ''"
