...
'   発行枚数
    lb_Kensu = Format(CXJ0130_PrtCnt, "###")
'   ﾌﾟﾘﾝﾀ出力先
    Op_Out(0).Value = True
...
'
    ...
    PB_Ent.Visible = H1Mode:    PNL_ENT.Visible = H1Mode
    PB_END.Visible = H1Mode:    PNL_END.Visible = H1Mode
    Timer2.Enabled = H1Mode
