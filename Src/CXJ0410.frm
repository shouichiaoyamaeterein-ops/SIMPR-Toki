...
Begin VB.Form CXJ0410 
   BackColor       =   &H00808000&
   BorderStyle     =   1  'å≈íË(é¿ê¸)
   Caption         =   "éÛíçèoâ◊èÛãµè∆âÔ"
   ClientHeight    =   11010
   ClientLeft      =   2955
   ClientTop       =   1860
   ClientWidth     =   14895
   ...
   Begin Cis3D_v60.CIS3D B2_Area2 
      ...
      Begin TrueOleDBGrid60.TDBGrid TDBGrid1 
         Bindings        =   "CXJ0410.frx":0000
         Height          =   2355
         Left            =   45
         OleObjectBlob   =   "CXJ0410.frx":0015
         TabIndex        =   37
         TabStop         =   0   'False
         Top             =   45
         Width           =   8310
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CXJ0410.frx":1332A
         Height          =   7740
         Left            =   60
         OleObjectBlob   =   "CXJ0410.frx":1333F
         TabIndex        =   16
         Top             =   60
         Width           =   14445
      End
   ...
   Begin VB.PictureBox H1_Area1 
      ...
      Begin Cis3D_v60.CIS3D CIS3D1 
         ...
         cAlingnment     =   6
         cPositionY      =   30
         Begin CisText_V60.CisText iH1_SyukaK 
            Height          =   360
            Left            =   45
            TabIndex        =   8
            Top             =   345
            ...
            MaxLength       =   7
         End
         Begin Cis3D_v60.CIS3D H1lb_SyukaK 
            Height          =   360
            Left            =   45
            Top             =   705
            Width           =   1695
   ...
   Begin Cis3D_v60.CIS3D UC_3D31 
      ...
      BackColor       =   14737632
      ForeColor       =   0
      Caption         =   "Å@Å@Å@Åy éÛíçèoâ◊èÛãµè∆âÔ Åz"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ÇlÇr ÉSÉVÉbÉN"
         Size            =   14.25
         Charset         =   128
...
'**********************************************************'
'**
'**       ÉtÉHÅ[ÉÄñº    :   éÛíçèoâ◊èÛãµè∆âÔ
'**       ÉtÉHÅ[ÉÄID    :   CXJ0410
'**       èàóùäTóv      :
'**
'**       çÏ  ê¨  ì˙    :  2004/03/19  By CIS
'**       ïœ  çX  ì˙    :  2005/03/03  By CIS - èdï°ãNìÆ¡™Ø∏Ç≈ãNìÆçœÇÃéûÅAÅwé¿çséûÉGÉâÅ['91'ÅxÇï\é¶Ç∑ÇÈëŒâûÅiTimerÃﬂ€ ﬂ√®ÇÃ Interval=0 Ç…èCê≥Åj
'**                        2007/04/10  By CIS îwî‘çÜ8åÖ
'**       ïœ  çX  ì˙    :  2008/05/07  By CIS - ã‡äzï\é¶
'**       ïœ  çX  ì˙    :  2008/06/11  By CIS - èåèÇ∆ï\é¶Ç…ÅyçHãÊÅzí«â¡
'**       ïœ  çX  ì˙    :  2009/09/21  By CIS - ìyäÚí√Ver
...
'**********************************************************'
    ...
    Dim CisComboSK           As CisCombo
    Dim CisComboJKB             As CisCombo
...
'+---------------------+
    With CisDBGrid
        ...
        .LayOutName = CisFun.WSID & "J0410.Lay"       ' ⁄≤±≥ƒèÓïÒäiî[êÊÅAÃß≤Ÿñº
        .PrintHeadLine = Ç†ÇË
        .PrintBodyLine = Ç†ÇË
        .PrintBodyGyo = 10
    ...
    '+---------------------+
    ' SKãÊï™
    Set CisComboSK = New CisCombo
    With CisComboSK
        Set .Connect = CisDB
        Set .CombObj = H1Cmb_SK
        .Control = ""
        .ComboName = ""
        .Ess = True
        .SetSpace = 50
    ...
    End With
    ' éÛíçãÊï™
    Set CisComboJKB = New CisCombo
    With CisComboJKB
        Set .Connect = CisDB
        Set .CombObj = H1Cmb_JKB
        .Control = "ñºèÃÉ}ÉXÉ^"
        .ComboName = "éÛíçãÊï™"
        .IniPath = gIniExe
        .SetSpace = 50
...
Private Sub PB_Look_Click()
    ...
    If PB_Look.Tag = "iH1_SyukaK" Then Call Look_SyukaK: Exit Sub
End Sub
'+-----------------------------+
'+       éÊà¯êÊåüçı             +
'+-----------------------------+
...
Private Sub Look_SyukaK()
    ...
    If RV_Rtn Then
        iH1_SyukaK = RV_TorcdK
        H1lb_SyukaK = RV_TorRName
    End If
End Sub
'+-----------------------------+
'+       ïiî‘åüçı              +
...
'+  iH1_SyukaK
'+-----------------------------+
Private Sub iH1_SyukaK_GotFocus()
    PB_Look.Tag = ActiveControl.Name
    PB_Look.Visible = True
End Sub
Private Sub iH1_SyukaK_LostFocus()
    If ActiveControl.Name <> "PB_Look" Then
        PB_Look.Tag = ""
        PB_Look.Visible = False
    End If
    H1lb_SyukaK = ""
    If TorNmGet(iH1_SyukaK, 6) Then
        H1lb_SyukaK = TRM_RName
    End If
End Sub
'+-----------------------------+
'+  H1Cmb_SK
'+-----------------------------+
Private Sub H1Cmb_SK_GotFocus()
    H1Cmb_SK.BackColor = iH1_SDate.cGotColor
End Sub
Private Sub H1Cmb_SK_LostFocus()
    H1Cmb_SK.BackColor = iH1_SDate.cLostColor
End Sub
'+-----------------------------+
'+  H1Cmb_JKB
'+-----------------------------+
Private Sub H1Cmb_JKB_GotFocus()
    H1Cmb_JKB.BackColor = iH1_SDate.cGotColor
End Sub
Private Sub H1Cmb_JKB_LostFocus()
    H1Cmb_JKB.BackColor = iH1_SDate.cLostColor
End Sub
'+----------------------------------+
'+      OpH1_DspKbn
'+----------------------------------+
    ...
    If Trim(iH1_SDate) <> "" And Trim(iH1_EDate) <> "" Then
       If iH1_SDate & Format(iH1_SBin, "00") > iH1_EDate & Format(iH1_EBin, "00") Then
            With CisFun
                ...
                Else
                   .MB_MSG(2) = "    èoâ◊ì˙ÅEï÷Çê≥ÇµÇ≠ì¸óÕÇµÇƒâ∫Ç≥Ç¢         "
                End If
...
'       ï\é¶èåè ÉZÉbÉg
       ...
       With CisFun
            ...
            End If
            ' î[ì¸êÊ
            .Where_Create AlphaMe, "î[ì¸êÊ", iH1_Torcd
            ' éÛì¸
            ...
            ' èoâ◊ä«óùïîèê
            .Where_Create AlphaMe, "èoâ◊ä«óùïîèê", iH1_SyukaK
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/11 INSERT START
            ' é©é–çHãÊ
'''            CisComboKK.CodeGet
'''            If CisComboKK.Code <> "" Then
'''               .Where_Create AlphaMe, "é©é–çHãÊ", CisComboKK.Code
'''            End If
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/11 INSERT END
            ' éËîzãÊï™
            Call CisComboSK.CodeGet
            If Trim(CisComboSK.Code) <> "" Then
               .Where_Create Numeric, "SKãÊï™", CisFun.Val2(CisComboSK.Code), , Create
            End If
            ' éÛíçãÊï™
            Call CisComboJKB.CodeGet
            If Trim(CisComboJKB.Code) <> "" Then
               .Where_Create Numeric, "éÛíçãÊï™", CisFun.Val2(CisComboJKB.Code), , Create
            End If
            ' ï\é¶ãÊï™
            ' ñ¢èoâ◊
            If OpH1_DspKbn(1).Value Then
               .Where_Create AlphaMe, "èoâ◊ì˙", "", ìôÇµÇ¢, Create
            End If
            ' èoâ◊çœ
            If OpH1_DspKbn(2).Value Then
               .Where_Create AlphaMe, "èoâ◊ì˙", "", ìôÇµÇ≠Ç»Ç¢, Create
            End If
...
' ⁄≤±≥ƒï\é¶ì‡óeÇÊÇË√ﬁ∞¿òAåãñºÇãÅÇﬂÇÈ
    ...
    gSL_Select = gSL_Select & ",î[ì¸ì˙,î[ì¸ï÷,î[ì¸êÊ,ïiî‘,îwî‘çÜ,éÛíçãÊï™,"
''  gSL_Select = gSL_Select & "èoâ◊ì˙,èoâ◊ï÷,èoâ◊éwé¶èëNO,èoâ◊éwé¶èëçsNO,éÛíçä«óùNO "   ' 2009.12.24 del
    gSL_Select = gSL_Select & "èoâ◊ì˙,èoâ◊ï÷,èoâ◊éwé¶èëçsNO,éÛíçä«óùNO "                ' 2009.12.24 add
    gSL_Select = gSL_Select & " from éÛíçèoâ◊èÛãµñ‚çáÉrÉÖÅ[ "
...
' Call .GridInitSet(œ∞ºﬁèàóù,ï™óﬁèàóù,√ﬁ∞¿òAåãñº,àÛç¸å©èoÇµ,àÛç¸åÖêî,çáåvàÛç¸)
    With CisDBGrid
         ...
         Call .GridInitSet(True, , "ï\é¶ïiî‘", "ïi       î‘", 25)
         '*-*-*-*-* 2008/04/10 Update Start
         'Call .GridInitSet(True, , "ï\é¶îwî‘çÜ", "îwî‘çÜ", 6)
         Call .GridInitSet(True, , "ï\é¶îwî‘çÜ", "îwî‘çÜ", 9)
         '*-*-*-*-* 2008/04/10 Update End
         Call .GridInitSet(True, , "ï“èWî[ì¸êÊ", "î[ì¸êÊ", 25)
         Call .GridInitSet(True, , "éÛì¸", "éÛ", 3)
         Call .GridInitSet(, , "é˚óeêî", "é˚óeêî", 6)
         Call .GridInitSet(, , "éÛíçñáêî", "éÛíçñáêî", 8, True)
         Call .GridInitSet(, , "î[ì¸êî", "éÛíçêî", 10, True)
         Call .GridInitSet(, , "èoâ◊ñáêî", "èoâ◊ñáêî", 8, True)
         Call .GridInitSet(, , "èoâ◊êî", "èoâ◊êî", 10, True)
         Call .GridInitSet(, , "èoâ◊ì˙ï÷", "èoâ◊ì˙ - ï÷", 15)
         Call .GridInitSet(, , "ï™î[êî", "ï™î[êî", 10, True)
         Call .GridInitSet(True, , "é‘å^", "é‘å^", 6)
         Call .GridInitSet(, , "ï™î[âÒêî", "ï™î[âÒêî", 9)
         Call .GridInitSet(True, , "éÛíçãÊï™ñº", "éÛíçãÊ", 10)
         ...
         Call .GridInitSet(True, , "ïiñº", "ïi        ñº", 40)
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/05/07 INSERT START
         Call .GridInitSet(, , "ã‡äz", "ã‡  äz", 13)
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/05/07 INSERT END
         Call .GridInitSet(True, , "ï“èWèoâ◊ä«óùïîèê", "èoâ◊ä«óùïîèê", 25)
'-----------------------------------------------------------' 2009.12.22 add start
         Call .GridInitSet(True, , "èoâ◊éwé¶èëNO", "èoâ◊éwé¶èëNO", 11)
'-----------------------------------------------------------' 2009.12.22 add end
    End With
End Sub
'+----------------------------------------------------------+
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/11 UPDATE START
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/05/07 UPDATE START
    'For ICnt = 0 To 20
    'For ICnt = 0 To 21
    For ICnt = 0 To 23
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/05/07 UPDATE END
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/11 UPDATE END
    ...
    gSL_Select = "Select * From éÛíçèoâ◊èÛãµñ‚çáÉrÉÖÅ["
    gSL_Select = gSL_Select & " Where ïiî‘ = '" & Adodc1.Recordset("ïiî‘") & "'"
    gSL_Select = gSL_Select & "   And î[ì¸êÊ = '" & Adodc1.Recordset("î[ì¸êÊ") & "'"
    gSL_Select = gSL_Select & "   And éÛì¸ = '" & Adodc1.Recordset("éÛì¸") & "'"
    gSL_Select = gSL_Select & "   And éÛíçä«óùNO = " & Adodc1.Recordset("éÛíçä«óùNO")
    gSL_Select = gSL_Select & " Order By î[ì¸î‘çÜ,î[ì¸ì˙,î[ì¸ï÷ "                           '2009/09/23 í«â¡
    ...
    If Adodc2.Recordset.RecordCount > 1 Then
       ...
       Do Until Adodc2.Recordset.EOF
          ...
          If Adodc1.Recordset("èoâ◊éwé¶èëNO") = Adodc2.Recordset("èoâ◊éwé¶èëNO") And _
             Adodc1.Recordset("èoâ◊éwé¶èëçsNO") = Adodc2.Recordset("èoâ◊éwé¶èëçsNO") Then
             Exit Do
          End If
...
Private Sub TotalDsp(JCol As Long)
    ...
    gSL_Select = "Select Sum(Case When ï™î[âÒêî = 0 Then î[ì¸êî Else 0 End ),Sum(èoâ◊êî),"
    gSL_Select = gSL_Select & "Sum(Case When èoâ◊ì˙ = '' Then î[ì¸êî Else 0 End),"
    gSL_Select = gSL_Select & "Sum(Case When ï™î[âÒêî = 0 Then éÛíçñáêî Else 0 End ),Sum(èoâ◊ñáêî),"
    gSL_Select = gSL_Select & "Sum(Case When èoâ◊ì˙ = '' Then éÛíçñáêî Else 0 End),"
    ...
    Select Case JCol
      Case -1
           wWhere = ""
      Case 0, 2, 3, 4, 11, 13, 15, 16, 17, 19, 24                       ' 2009.12.24 upd : 24Çí«â¡
           ' î[ì¸ì˙ÅEï÷(0),ïiî‘(2),îwî‘çÜ(3),î[ì¸êÊ(4),èoâ◊ì˙ÅEï÷(11)
           ' é‘å^(13),éÛíçãÊ(15),SKãÊï™(16),íuèÍ(17),å_ñÒêÊ(19),èoâ◊éwé¶èëNO(24)
      ...
      Case 1            ' î[ì¸î‘çÜ
           wMsg = DBGrid1.Columns(JCol).Caption
           wValue = DBGrid1.Columns(JCol).Text
           wWhere = "Substring(î[ì¸î‘çÜ,1,5) = '" & Mid(DBGrid1.Columns(JCol).Text, 1, 5) & "'"
      Case 5            ' î[ì¸êÊ•éÛì¸
           wMsg = "î[ì¸êÊ•éÛì¸"
