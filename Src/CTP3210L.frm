VERSION 5.00
Begin VB.Form CTP3210L 
   Caption         =   " êVeÇ©ÇÒÇŒÇÒèoâ◊ïœä∑ÉäÉXÉg"
   ClientHeight    =   2265
   ClientLeft      =   795
   ClientTop       =   2625
   ClientWidth     =   16755
   ...
   Begin VB.Label Label34 
      AutoSize        =   -1  'True
      Caption         =   "Å¶Å¶ êVeÇ©ÇÒÇŒÇÒèoâ◊ïœä∑ÉäÉXÉg Å¶Å¶"
      BeginProperty Font 
         Name            =   "ÇlÇr ñæí©"
         Size            =   18
         Charset         =   128
...
'**********************************************************'
'**
'**       ÉtÉHÅ[ÉÄñº    :  eÇ©ÇÒÇŒÇÒèoâ◊ïœä∑ÉäÉXÉg
'**       ÉtÉHÅ[ÉÄID    :  CTP3210L
'**       èàóùäTóv      :
'**
'**       çÏ  ê¨  ì˙    :  2008/07/22
...
Private Sub Form_Load()
    ...
    '*---------------------*
    With eKanban_Prt
        .iPrtTitle = "eÇ©ÇÒÇŒÇÒèoâ◊ïœä∑ÉäÉXÉg"
        .iLineMax = 40
        .iPaperSize = p_A4
...
Private Function PrintProc()
    ...
    Do Until Not EHT_RDSTS
        With EHT
        
            Call eKanban_Prt.ClrLstFld("B1")
            '*---------------------------------*
            '*  HeadïîÅ@àÛç¸
            '*---------------------------------*
                Call HeadWrite(0)
            ...
            B1_Ukeir = RTrim(.éÛì¸)
            If Trim(EHT.î[ì¸ì˙) <> "" Then
                With CisFun
                    .DateE_BefVal = EHT.î[ì¸ì˙
                    .DateEdit
                    gStr = .DateE_AfVal
                End With
                If Trim(EHT.î[ì¸ï÷) <> "" Then
                   gStr = gStr & "-" & EHT.î[ì¸ï÷
                Else
                   gStr = gStr & "   "
                End If
            ...
            If Trim(EHT.î“âÒì˙) <> "" Then
                With CisFun
                    .DateE_BefVal = EHT.î“âÒì˙
                    .DateEdit
                    gStr = .DateE_AfVal
                End With
                If Trim(EHT.î“âÒï÷) <> "" Then
                   gStr = gStr & "-" & EHT.î“âÒï÷
                Else
                   gStr = gStr & "   "
                End If
...
'
    ...
    With eKanban_Prt
        ...
        With CisFun
            .DateE_BefVal = EHT.èàóùì˙
            .DateEdit
            gStr = .DateE_AfVal
        End With
        gStr = gStr & " - " & Format(EHT.èàóùâÒêî, "000")
        H1_CVTDATE = gStr
