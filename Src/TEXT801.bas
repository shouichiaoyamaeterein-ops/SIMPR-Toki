...
'*   変更日  :
'*---------------------------------------------------------------------------------
Dim T801_Cnt         As Long
Dim T801_ST          As Long

Global T801_HYMD        As String
Global T801_SEQ         As String

'+----------------------------------+
'+  テーブル出力
'+----------------------------------+
Public Function T801ConVertPut(ConvData As String, lErr As String) As Boolean
    lErr = ""

    On Error GoTo T801ConVertPut_Er:
...
T801ConVertPut_Er:
    ...
    ER_MSG1 = "         財務データ変換処理（８０１）      " & vbCrLf & " " & vbCrLf
