...
'   #-------------------#
    ...
    lb_msg.Caption = "テキスト受注変換リスト発行"
    If Text_Proc = 1 Then
       lb_msg.Caption = "テキスト出荷変換リスト発行"
    End If
'   #-------------------#
'   # 画面中央位置表示  #
'   #-------------------#
...
'
    If Text_CvtList(Text_Proc) Then
        If Text_CvtErr(Text_Proc) = 0 Then H1Ch_Err.Value = 1
        If Text_CvtKari(Text_Proc) = 0 Then H1Ch_Kari.Value = 1
        If Text_CvtEtc(Text_Proc) = 0 Then H1Ch_Etc.Value = 1
        If Text_CvtDbl(Text_Proc) = 0 Then H1Ch_Dbl.Value = 1
    Else
        H1Ch_Err.Value = 1
        H1Ch_Kari.Value = 1
        H1Ch_Etc.Value = 1
...
Private Sub ReturnPress()
    ...
    Else
        If H1Ch_Err.Value = 0 Then Text_CvtErr(Text_Proc) = 1
        If H1Ch_Kari.Value = 0 Then Text_CvtKari(Text_Proc) = 1
        If H1Ch_Etc.Value = 0 Then Text_CvtEtc(Text_Proc) = 1
        If H1Ch_Dbl.Value = 0 Then Text_CvtDbl(Text_Proc) = 1
    End If
    ...
    If THNRead(gSL_Select) Then
       ...
       lb_msg = "【 テキスト変換 】 変換リスト 印刷中": DoEvents
       With Text_Prt
            If Text_Proc = 0 Then
               '------------------------------------------- テキスト受注変換リスト発行
               Set .iPrtForm = CXJ0710L
               .dpMSG = "テキスト受注変換リスト　印刷中"
            Else
               '------------------------------------------- テキスト出荷変換リスト発行
               Set .iPrtForm = CXJ0710L
               .dpMSG = "テキスト出荷変換リスト　印刷中"
            End If
