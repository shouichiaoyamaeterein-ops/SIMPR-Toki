...
'**********************************************************'
'**
'**       ÉtÉHÅ[ÉÄñº    :  éxããì`ï[Å@î≠çs
'**       ÉtÉHÅ[ÉÄID    :  CXHZ0530L
'**       èàóùäTóv      :
'**
'**       çÏ  ê¨  ì˙    :  2008/09/04
'**       ïœ  çX  ì˙    :  2009/02/03 îwî‘çÜ,ÉoÉOèCê≥
'**       ïœ  çX  ì˙    :  2009/05/13 ñáêî/èdó Å@ïœçX
'**
'**********************************************************'
'#î‰ärëﬁîóp#
...
'    Call CisPrtCXHZ0530.ClrLstFld("B1")
'
'*-----------------------------------------*
...
'                End If
                ...
                With CisPrtCXHZ0530
                    .cDataCnt = .cDataCnt + 1
                    .dpCountDisp Format(.cDataCnt, "#,###") & " / " & Format(CXHZ0530_PrtCnt, "#,###")
                    .cLine = 0
                    .cPage = .cPage + 1
