...
Begin VB.Form CKN3235 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CKN3235.frx":0000
         Height          =   6525
         Left            =   90
         OleObjectBlob   =   "CKN3235.frx":0015
         TabIndex        =   11
         Top             =   60
         Width           =   14115
      End
...
'**
'**       フォーム名    :   品番取引先マスタ検索
'**       フォームID    :   CKN3235 (Based CKK0035)
'**       処理概要      :
'**
'**       作  成  日    :   2003/12/19  By CIS
'**       変  更  日    :   2009/03/03  By CIS 部品区分追加
'**       変  更  日    :   2009/12/24  By CIS CKK0035をもとに代表得意先を追加
...
Private Sub PB_END_Click()
    Unload CKN3235              ' 2009.12.24 upd : Unload CKK0035
End Sub
'+----------------------------+
'+    入  力  キ ー(Enter)     +
'+----------------------------+
...
' 選択条件セット
    ...
    With CisFun
        ...
        .Where_Create AlphaMe, "ISNULL(HN.得意先,'')", iH1_Tokui            ' 2009.12.24 add
