...
Begin VB.Form CXM0030BAK 
   ...
   Begin Cis3D_v60.CIS3D Back_Kotei 
      ...
      Begin Cis3D_v60.CIS3D Back_Grid3 
         ...
         Begin vsFlexLib.vsFlexArray vsGrid3 
            ...
            Appearance      =   1
            ConvInfo        =   1418783674
            FormatString    =   $"CXM0030_BAK20091016.frx":0000
            Rows            =   5
            Cols            =   25
            BackColor       =   12648384
            BackColorBkg    =   12632256
      ...
      Begin Cis3D_v60.CIS3D CIS3D9 
         ...
         Begin CisText_V60.CisText iB1_Image 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Text            =   $"CXM0030_BAK20091016.frx":00E5
            MaxLength       =   255
         End
      End
   ...
   Begin VB.PictureBox B1_Area2 
      ...
      Begin vsFlexLib.vsFlexArray vsGrid1 
         ...
         Appearance      =   1
         ConvInfo        =   1418783674
         FormatString    =   $"CXM0030_BAK20091016.frx":01E8
         Rows            =   6
         Cols            =   44
         BackColor       =   12648447
         BackColorBkg    =   12632256
...
End Sub
'+----------------------------+
'+    çHíˆâÊñ ï\é¶èIóπÉL Å[   +
'+----------------------------+
Private Sub PB_KEND_Click()
    Back_Kotei.Visible = False
    PNL_PF.Visible = True
    PB_Kotei.Enabled = True
    B1_Area1.Enabled = True
    B3_Area1.Enabled = True
    B3_Area3.Enabled = True
...
Private Sub PB_KADD_Click()
    ...
    K_Sykbnm_K.ForeColor = &HFFFF&   '(â©êF)
    K_Select_Data = False
End Sub
'+----------------------------+
'+    çHíˆâÊñ Å@Å@èCê≥ÉL Å[   +
'+----------------------------+
Private Sub PB_KMNT_Click()
    ...
    SyoriNM_K = "èCê≥"
    K_Sykbnm_K = SyoriNM_K
    K_Sykbnm_K.ForeColor = &HFF0000  '(ê¬êF)
    K_Select_Data = True
End Sub
'+----------------------------+
'+    çHíˆâÊñ Å@Å@çÌèúÉL Å[   +
'+----------------------------+
Private Sub PB_KDEL_Click()
    ...
    SyoriNM_K = "çÌèú"
    K_Sykbnm_K = SyoriNM_K
    K_Sykbnm_K.ForeColor = &HFF&     '(ê‘êF)
    K_Select_Data = True
End Sub
'+----------------------------+
'+    çHíˆâÊñ Å@Å@éÊè¡ÉL Å[   +
'+----------------------------+
...
Private Sub B3Comb_KZaiko_Click()
    ...
    Select Case gStr
        Case "2"    ' åWêî
            ...
            Zaiko_Label.Left = iB3_KZaiko.Left + iB3_KZaiko.Width + 60
            Zaiko_Label = "Åì"
        ...
        Case "4"    ' ì˙êî
            ...
            iB3_KZaikoL.Visible = False
            Zaiko_Label.Left = iB3_KZaikoDay.Left + iB3_KZaikoDay.Width + 60
            Zaiko_Label = "ì˙"
            Zaiko_Label.Visible = True
        Case Else
            iB3_KZaiko.Visible = False
...
Private Sub B3Comb_KMZaiko_Click()
    ...
    Select Case gStr
        Case "2"    ' åWêî
            ...
            Zaiko_Label.Left = iB3_KMZaiko.Left + iB3_KMZaiko.Width + 60
            Zaiko_Label = "Åì"
            Zaiko_Label.Visible = True
        Case "3"    ' î≠íçì_
        ...
        Case "4"    ' ì˙êî
            ...
            iB3_KMZaikoL.Visible = False
            Zaiko_Label.Left = iB3_KMZaikoDay.Left + iB3_KMZaikoDay.Width + 60
            Zaiko_Label = "ì˙"
            Zaiko_Label.Visible = True
        Case Else
            iB3_KMZaiko.Visible = False
...
End Sub
'+-----------------------------+
'+  B3Chk_NaiGaiÅ@ì‡äOãÊï™
'+-----------------------------+
Private Sub B3Chk_NaiGai_Click()
    If B3Chk_NaiGai.Value = 0 Then
       B3Chk_NaiGai.Caption = "ì‡"
    Else
       B3Chk_NaiGai.Caption = "äO"
    End If
...
End Sub
'+-----------------------------+
'+  B3Chk_RobotÅ@€ŒﬁØƒ/íPî≠ãÊï™
'+-----------------------------+
Private Sub B3Chk_Robot_Click()
    If B3Chk_Robot.Value = 0 Then
       B3Chk_Robot.Caption = "€ŒﬁØƒ"
       gSL_Select = "Select ë‰êî From éÊà¯êÊçHíˆÉ}ÉXÉ^ "
       gSL_Select = gSL_Select & " Where éÊà¯êÊCD = '" & RTrim(iB2_Torcd) & "'"
       gSL_Select = gSL_Select & " And   ã@äB = '" & RTrim(iB3_Kikai) & "'"
       gSL_Select = gSL_Select & " And   ã@äBNO = '" & RTrim(iB3_KikaiNo) & "'"
       If TKTRead(gSL_Select, 1) Then
          If TKT.ë‰êî <> 0 Then
             B3lb_Daisu = Format(TKT.ë‰êî, "#0") & "ë‰"
          Else
             B3lb_Daisu = ""
          End If
       Else
       ...
       End If
    Else
       B3Chk_Robot.Caption = "íPî≠"
       B3lb_Daisu = ""
    End If
End Sub
'+-----------------------------+
'+  B3Chk_PureÅ@íIâµÃﬂ⁄º∞ƒàÛç¸ãÊï™
'+-----------------------------+
Private Sub B3Chk_Pure_Click()
    If B3Chk_Pure.Value = 0 Then
       B3Chk_Pure.Caption = "î≠çsóL"
    Else
       B3Chk_Pure.Caption = "î≠çsñ≥"
    End If
End Sub
'+-----------------------------+
'+  B3Chk_SyukaÅ@èoâ◊ä«óù
'+-----------------------------+
Private Sub B3Chk_Syuka_Click()
    If B3Chk_Syuka.Value = 0 Then
       B3Chk_Syuka.Caption = "Åõ"
    Else
       B3Chk_Syuka.Caption = "Å~"
    End If
End Sub
'+-----------------------------+
'+  B3Chk_SetÅ@æØƒïiî‘
...
End Sub
'+-----------------------------+
'+  B3Chk_NipoÅ@ì˙ïÒä«óù
'+-----------------------------+
Private Sub B3Chk_Nipo_Click()
    If B3Chk_Nipo.Value = 0 Then
       B3Chk_Nipo.Caption = "Åõ"
    Else
       B3Chk_Nipo.Caption = "Å~"
    End If
End Sub
'+---------------------------------------------+
'+  iB3_Kikai    ã@äB
...
Private Sub iB3_Kikai_LostFocus()
    ...
    If RTrim(iB3_Kikai) <> "" Then
       Call MeisyoGet("ã@äB", RTrim(iB3_Kikai))
...
Private Sub iB3_KikaiNo_LostFocus()
    ...
    If RTrim(iB3_KikaiNo) <> "" Then
       Call MeisyoGet("ã@äBNO", RTrim(iB3_KikaiNo))
...
Private Sub iB3_Kotei_LostFocus()
    ...
    End If
    B3lb_Koteinm = ""
    If MeisyoGet("çHíˆä«óù", iB3_Kotei) Then
...
'  ( ämîFÉÅÉbÉZÅ[ÉW )
    ...
    With CisFun
        .MB_Lines = 4
        .MB_MSG(2) = "     çHèáÅF" & Format(wKojyun, "#0") & " ÇÃçÌèúèàóùÇçsÇ¢Ç‹Ç∑      "
        .MB_Title = "çÌèúèàóù"
...
'   É}ÉXÉ^çÄñ⁄à⁄ëó
    gSL_Select = "SELECT * From ïiî‘çHèáÉ}ÉXÉ^"
    gSL_Select = gSL_Select & " WHERE ïiî‘ = '" & RTrim(iH1_Hinbn) & "'"
    gSL_Select = gSL_Select & " And   éÊà¯êÊ = '" & RTrim(iB2_Torcd) & "'"
    gSL_Select = gSL_Select & " And   éÛì¸ = '" & RTrim(iB2_Ukeir) & "'"
    If B2Op_Hinmoku(0) Then
    ...
    Else
       gSL_Select = gSL_Select & " And   ïiñ⁄ = 1"
    End If
    gSL_Select = gSL_Select & " And   çHèá = " & CisFun.Val2(iB3_Kojyun)
    ...
    Else
       Call ItemsClearHKT
       AddFlg = True
       HKT.ïiî‘ = RTrim(iH1_Hinbn)
    End If
    
    With HKT
        .ïiî‘ = RTrim(iH1_Hinbn)
        .éÊà¯êÊ = RTrim(iB2_Torcd)
        .éÛì¸ = RTrim(iB2_Ukeir)
        If B2Op_Hinmoku(0) Then
           .ïiñ⁄ = 0
        Else
           .ïiñ⁄ = 1
        End If
        .çHèá = CisFun.Val2(iB3_Kojyun)
        
        .ã@äB = RTrim(iB3_Kikai)
        .äOíçâ¡çH = B3Chk_NaiGai
        If .äOíçâ¡çH = 1 Then
           .äOíçâ¡çHêÊCD = RTrim(iB3_GTorcd)
        Else
           .äOíçâ¡çHêÊCD = ""
        End If
        .ã@äBNO = RTrim(iB3_KikaiNo)
        .ÉçÉ{ÉbÉgãÊï™ = B3Chk_Robot
        .çHíˆ = RTrim(iB3_Kotei)
        .äÓèÄçHêîñº1 = RTrim(iB3_Kosunm1)
        .äÓèÄçHêî1 = CisFun.Val2(iB3_Kosu1)
        .äÓèÄçHêîñº2 = RTrim(iB3_Kosunm2)
        .äÓèÄçHêî2 = CisFun.Val2(iB3_Kosu2)
        .çHíˆêî = CisFun.Val2(iB3_KoteiSu)
        .íIâµÉvÉåÉVÅ[Égî≠çs = B3Chk_Pure.Value
        .íuèÍ = RTrim(iB3_Okiba1) & Space(2 - Len(iB3_Okiba1)) & _
         ...
         .èoâ◊ä«óù = B3Chk_Syuka.Value
         .ÉZÉbÉgïiî‘ = B3Chk_Set.Value
         If CisFun.Val2(iB3_KCycle1) <> 0 Or CisFun.Val2(iB3_KCycle2) <> 0 Or _
            CisFun.Val2(iB3_KCycle3) <> 0 Then
            .ÉTÉCÉNÉã = Format(iB3_KCycle1, "0") & _
                          Format(iB3_KCycle2, "00") & _
                          Format(iB3_KCycle3, "00")
         Else
            .ÉTÉCÉNÉã = ""
         End If
         .é¿çHêî = CisFun.Val2(iB3_JKosu)
         .åWêî1 = CisFun.Val2(iB3_KKeisu1)
         .åWêî2 = CisFun.Val2(iB3_KKeisu2)
         .LT = CisFun.Val2(iB3_KLT)
         CisComboKZaiko.CodeGet
         .ç›å…ä«óùãÊï™ = CisFun.Val2(CisComboKZaiko.Code)
         .ç›å…åWêî = CisFun.Val2(iB3_KZaiko)
         .ç›å…î≠íçì_ = CisFun.Val2(iB3_KZaikoL)
         .ç›å…ì˙êî = CisFun.Val2(iB3_KZaikoDay)
         ...
         End Select
         CisComboKMZaiko.CodeGet
         .ç≈ëÂç›å…ä«óùãÊï™ = CisFun.Val2(CisComboKMZaiko.Code)
         .ç≈ëÂç›å…åWêî = CisFun.Val2(iB3_KMZaiko)
         .ç≈ëÂç›å…î≠íçì_ = CisFun.Val2(iB3_KMZaikoL)
         .ç≈ëÂç›å…ì˙êî = CisFun.Val2(iB3_KMZaikoDay)
         Select Case .ç≈ëÂç›å…ä«óùãÊï™
              Case 2: .ç≈ëÂç›å…ä«óùêîíl = .ç≈ëÂç›å…åWêî
              Case 3: .ç≈ëÂç›å…ä«óùêîíl = .ç≈ëÂç›å…î≠íçì_
              Case 4: .ç≈ëÂç›å…ä«óùêîíl = .ç≈ëÂç›å…ì˙êî
         End Select
         .é˚óeêî = CisFun.Val2(iB3_KSyuyo)
         .ì˙ïÒèoóÕ = B3Chk_Nipo.Value
    End With
...
'ïiî‘çHèáÉZÉbÉgïiî‘É}ÉXÉ^
    With CisDB
        ...
        Else
           .SQL = .SQL & " And   ïiñ⁄ = 1"
        End If
        .SQL = .SQL & " And   çHèá = " & CisFun.Val2(iB3_Kojyun)
        On Error GoTo DBPut_K_Err
        .DBExec
    End With

    HSE.ïiî‘ = RTrim(iH1_Hinbn)
    HSE.éÊà¯êÊ = RTrim(iB2_Torcd)
    HSE.éÛì¸ = RTrim(iB2_Ukeir)
    If B2Op_Hinmoku(0) Then
       HSE.ïiñ⁄ = 0
    Else
       HSE.ïiñ⁄ = 1
    End If
    HSE.çHèá = CisFun.Val2(iB3_Kojyun)
    With vsGrid4
         For mIx = 1 To .Rows - 1
             If Trim(.TextMatrix(mIx, 1)) <> "" Then
                HSE.ÉZÉbÉgïiî‘ = Trim(.TextMatrix(mIx, 1))
                HSE.éÊêî = CisFun.Val2(Trim(.TextMatrix(mIx, 2)))
                HSE.çÏê¨é“ = gTanto
...
Private Function BodyKChk() As Boolean
 ...
 ' ã@äB(çÏã∆)/ã@äBáÇ(édól) Ç«ÇøÇÁÇ©ïKê{ì¸óÕ
    If RTrim(iB3_Kikai) = "" And RTrim(iB3_KikaiNo) = "" Then
        With CisFun
            .MB_Lines = 4
            .MB_MSG(2) = "    ã@äB/ã@äBáÇÇ«ÇøÇÁÇ©Çì¸óÕÇµÇƒâ∫Ç≥Ç¢            "
            .MB_Title = ""
            .MB_Button = Error
            .MBOX
        End With
    ...
    End If
    If RTrim(iB3_Kikai) <> "" Then
       If Not MeisyoGet("ã@äB", RTrim(iB3_Kikai)) Then
           With CisFun
               .MB_Lines = 4
               .MB_MSG(2) = "    ã@äB(çÏã∆)Ç™ñ¢ìoò^Ç≈Ç∑            "
               .MB_Title = ""
               .MB_Button = Error
               .MBOX
           End With
    ...
    End If
    If RTrim(iB3_KikaiNo) <> "" Then
       If Not MeisyoGet("ã@äBNO", RTrim(iB3_KikaiNo)) Then
           With CisFun
               .MB_Lines = 4
               .MB_MSG(2) = "    ã@äBáÇ(édól)Ç™ñ¢ìoò^Ç≈Ç∑            "
               .MB_Title = ""
               .MB_Button = Error
               .MBOX
           End With
    ...
    If B3Chk_NaiGai.Value = 1 Then
       If RTrim(iB3_GTorcd) = "" Then
           With CisFun
               .MB_Lines = 4
               .MB_MSG(2) = "    äOíçâ¡çHêÊÇì¸óÕÇµÇƒâ∫Ç≥Ç¢            "
               .MB_Title = ""
               .MB_Button = Error
               .MBOX
           End With
       ...
       If Not TorNmGet(iB3_GTorcd, 8) Then
           With CisFun
               .MB_Lines = 4
               .MB_MSG(2) = "    äOíçâ¡çHêÊÇ™ñ¢ìoò^Ç≈Ç∑            "
               .MB_Title = ""
               .MB_Button = Error
               .MBOX
           End With
    ...
    If B3Chk_Set.Value = 1 Then
       ...
       With vsGrid4
            ...
            If Not SetHinFlg Then
                ...
                With CisFun
                     .MB_Lines = 4
                     .MB_MSG(2) = "    æØƒïiî‘Çì¸óÕÇµÇƒâ∫Ç≥Ç¢           "
                     .MB_Title = ""
                     .MB_Button = Error
                     .MBOX
                  End With
...
'                      æŸåÖêî,óÒî‘çÜ,å©èoÇµì‡óe,ï™óﬁ¿≤Ãﬂ)
'       Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 0, 0, "No")
'|èoâ◊ä«óù|æØƒïiî‘|ÉTÉCÉNÉã|é¿çHêî|åWêî1|åWêî2|LT|ç›å…ä«óù         |ç›å…ä«óù(ç≈ëÂ)  |é˚óeêî  |ì˙ïÒ
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 4, 0, "çHèá")
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 12, 1, "ã@äB(çÏã∆)")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 4, 2, "ì‡äO")
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 12, 3, "äOíçâ¡çH")
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 12, 4, "ã@äBáÇ(édól)")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 10, 5, "€ŒﬁØƒ/íPî≠")
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 12, 6, "çHíˆ")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 15, 7, "äÓèÄçHêî1")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 15, 8, "äÓèÄçHêî2")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 9, 9, "çHíˆêî")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 6, 10, "Ãﬂ⁄º∞ƒ")
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 11, 11, "íuèÍ")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 4, 12, "èoâ◊")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 7, 13, "æØƒïiî‘")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 5, 14, "ª≤∏Ÿ")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 6, 15, "é¿çHêî")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 5, 16, "åWêî1")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 5, 17, "åWêî2")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 2, 18, "LT")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 10, 19, "ç›å…ä«óù")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 10, 20, "ç≈ëÂç›å…")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 7, 21, "é˚óeêî")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 4, 22, "ì˙ïÒ")
'Å@∏ﬁÿØƒﬁëIëèàóùópÅ@ëﬁî¥ÿ±
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç»Çµ, 0, 23, "Select")
'  ï\é¶ ﬂ¿∞›æØƒ
'       Call .PatanSet( ﬂ¿∞›NO,ï\é¶ÉpÉ^Å[Éì)
...
Private Sub HKTInfoToGrid(SetRow As Long)
    With vsGrid3
        ...
        End If
        ' ì‡äO
        If HKT.äOíçâ¡çH = 0 Then
           .TextMatrix(SetRow, SCol(2)) = "ì‡"
        Else
           .TextMatrix(SetRow, SCol(2)) = "äO"
        End If
        ' äOíçâ¡çHêÊ
        If HKT.äOíçâ¡çH = 1 Then
           .TextMatrix(SetRow, SCol(3)) = RTrim(HKT.äOíçâ¡çHêÊCD) & "ÅF" & RTrim(HKT.äOíçâ¡çHñº)
        Else
           .TextMatrix(SetRow, SCol(3)) = ""
        End If
        ' ã@äBNO(édól)
        If RTrim(HKT.ã@äBNO) <> "" Then
           .TextMatrix(SetRow, SCol(4)) = RTrim(HKT.ã@äBNO) & ":" & RTrim(HKT.ã@äBNOñº)
        Else
           .TextMatrix(SetRow, SCol(4)) = ""
        End If
        ' €ŒﬁØƒ/íPî≠
        If HKT.ÉçÉ{ÉbÉgãÊï™ = 0 Then
           .TextMatrix(SetRow, SCol(5)) = "ÉçÉ{ÉbÉg"
        Else
           .TextMatrix(SetRow, SCol(5)) = "íPî≠"
        End If
        ' çHíˆ
        If RTrim(HKT.çHíˆ) <> "" Then
           .TextMatrix(SetRow, SCol(6)) = RTrim(HKT.çHíˆ) & ":" & RTrim(HKT.çHíˆñº)
        Else
        ...
        ' äÓèÄéûä‘1
        If RTrim(HKT.äÓèÄçHêîñº1) <> "" Then
           .TextMatrix(SetRow, SCol(7)) = RTrim(HKT.äÓèÄçHêîñº1) & ":" & Format(HKT.äÓèÄçHêî1, "#0.000")
        Else
           .TextMatrix(SetRow, SCol(7)) = Format(HKT.äÓèÄçHêî1, "#0.000")
        End If
        ' äÓèÄéûä‘2
        If RTrim(HKT.äÓèÄçHêîñº2) <> "" Then
           .TextMatrix(SetRow, SCol(8)) = RTrim(HKT.äÓèÄçHêîñº2) & ":" & Format(HKT.äÓèÄçHêî2, "#0.000")
        Else
           .TextMatrix(SetRow, SCol(8)) = Format(HKT.äÓèÄçHêî2, "#0.000")
        End If
        ' çHíˆêî
        .TextMatrix(SetRow, SCol(9)) = Format(HKT.çHíˆêî, "#0.0")
        ' íIâµÃﬂ⁄º∞ƒ
        If HKT.íIâµÉvÉåÉVÅ[Égî≠çs = 0 Then
           .TextMatrix(SetRow, SCol(10)) = "î≠çsóL"
        Else
           .TextMatrix(SetRow, SCol(10)) = "î≠çsñ≥"
        End If
        .Redraw = True
        
        ' íuèÍ
        If RTrim(HKT.íuèÍ) <> "" Then
           .TextMatrix(SetRow, SCol(11)) = Mid(HKT.íuèÍ, 1, 2) & "-" & Mid(HKT.íuèÍ, 3, 2) & "-" & Mid(HKT.íuèÍ, 5, 2) & "-" & Mid(HKT.íuèÍ, 7, 2)
        Else
           .TextMatrix(SetRow, SCol(11)) = ""
        End If
        ' èoâ◊ä«óù
        If HKT.èoâ◊ä«óù = 0 Then
           .TextMatrix(SetRow, SCol(12)) = "Åõ"
        Else
           .TextMatrix(SetRow, SCol(12)) = "Å~"
        End If
        ' æØƒïiî‘
        If HKT.ÉZÉbÉgïiî‘ = 0 Then
           .TextMatrix(SetRow, 13) = "ñ≥"
        Else
           .TextMatrix(SetRow, 13) = "óL"
        End If
        ' ÉTÉCÉNÉã
        If Trim(HKT.ÉTÉCÉNÉã) <> "" Then
            .TextMatrix(SetRow, 14) = Mid(HKT.ÉTÉCÉNÉã, 1, 1) & "-" & _
                                     Mid(HKT.ÉTÉCÉNÉã, 2, 2) & "-" & _
                                     Mid(HKT.ÉTÉCÉNÉã, 4, 2)
        End If
        ' é¿çHêî
        If HKT.é¿çHêî <> 0 Then
           .TextMatrix(SetRow, 15) = Format(HKT.é¿çHêî, "#0.00")
        Else
           .TextMatrix(SetRow, 15) = ""
        End If
        ' åWêî1
        If HKT.åWêî1 <> 0 Then
           .TextMatrix(SetRow, 16) = Format(HKT.åWêî1, "0.00")
        Else
           .TextMatrix(SetRow, 16) = ""
        End If
        ' åWêî2
        If HKT.åWêî2 <> 0 Then
           .TextMatrix(SetRow, 17) = Format(HKT.åWêî2, "0.00")
        Else
        ...
        End If
        ' ç›å…ä«óù
        Select Case HKT.ç›å…ä«óùãÊï™
               Case 0: .TextMatrix(SetRow, 19) = "Ç»Çµ"
               Case 1: .TextMatrix(SetRow, 19) = "Ç†ÇË"
               Case 2: .TextMatrix(SetRow, 19) = "åWêî"
               Case 3: .TextMatrix(SetRow, 19) = "î≠íçì_"
               Case 4: .TextMatrix(SetRow, 19) = "ì˙êî"
        End Select
        ' ç≈ëÂç›å…ä«óù
        Select Case HKT.ç≈ëÂç›å…ä«óùãÊï™
               Case 0: .TextMatrix(SetRow, 20) = "Ç»Çµ"
               Case 1: .TextMatrix(SetRow, 20) = "Ç†ÇË"
               Case 2: .TextMatrix(SetRow, 20) = "åWêî"
               Case 3: .TextMatrix(SetRow, 20) = "î≠íçì_"
               Case 4: .TextMatrix(SetRow, 20) = "ì˙êî"
        End Select
        ' é˚óeêî
        If HKT.é˚óeêî <> 0 Then
           .TextMatrix(SetRow, 21) = Format(HKT.é˚óeêî, "##,###")
        Else
           .TextMatrix(SetRow, 21) = ""
        End If
        ' ì˙ïÒä«óù
        If HKT.ì˙ïÒèoóÕ = 0 Then
           .TextMatrix(SetRow, 22) = "Åõ"
        Else
           .TextMatrix(SetRow, 22) = "Å~"
        End If
    End With
End Sub
'*************************************************
'*      çHèáèÓïÒÉOÉäÉbÉhÇÊÇËì¸óÕàÊÇ÷ÉZÉbÉg        *
'*************************************************
Private Sub GridToText3(wKojyun As Byte)
    ...
    With HKT
        ...
        Else
           gSL_Select = gSL_Select & " And   HK.ïiñ⁄ = 1"
        End If
        gSL_Select = gSL_Select & " And HK.çHèá = " & wKojyun
        ...
        Call iB3_Kikai_LostFocus
        ' ì‡äO
        B3Chk_NaiGai.Value = .äOíçâ¡çH
        Call B3Chk_NaiGai_Click
        If B3Chk_NaiGai.Value = 1 Then
           iB3_GTorcd = .äOíçâ¡çHêÊCD
        ...
        Call iB3_Kotei_LostFocus
        ' äÓèÄéûä‘1
        iB3_Kosunm1 = RTrim(.äÓèÄçHêîñº1)
        iB3_Kosu1 = Format(.äÓèÄçHêî1, "#0.000")
        ' äÓèÄéûä‘2
        iB3_Kosunm2 = RTrim(.äÓèÄçHêîñº2)
        iB3_Kosu2 = Format(.äÓèÄçHêî2, "#0.000")
        ' çHíˆêî
        iB3_KoteiSu = Format(.çHíˆêî, "#0.0")
        ' íIâµÃﬂ⁄º∞ƒ
        B3Chk_Pure.Value = .íIâµÉvÉåÉVÅ[Égî≠çs
        Call B3Chk_Pure_Click
        ' íuèÍ
        iB3_Okiba1 = Mid(.íuèÍ, 1, 2)
        iB3_Okiba2 = Mid(.íuèÍ, 3, 2)
        iB3_Okiba3 = Mid(.íuèÍ, 5, 2)
        iB3_Okiba4 = Mid(.íuèÍ, 7, 2)
        ' èoâ◊ä«óù
        B3Chk_Syuka.Value = .èoâ◊ä«óù
        Call B3Chk_Syuka_Click
        ' æØƒïiî‘
        B3Chk_Set.Value = .ÉZÉbÉgïiî‘
        Call B3Chk_Set_Click
        ' ÉTÉCÉNÉã
        iB3_KCycle1 = Mid(.ÉTÉCÉNÉã, 1, 1)
        iB3_KCycle2 = Mid(.ÉTÉCÉNÉã, 2, 2)
        iB3_KCycle3 = Mid(.ÉTÉCÉNÉã, 4, 2)
        ' é¿çHêî
        iB3_JKosu = Format(.é¿çHêî, "#0.00")
        ' åWêî1
        iB3_KKeisu1 = Format(.åWêî1, "0.00")
        ' åWêî2
        iB3_KKeisu2 = Format(.åWêî2, "0.00")
        ' LT
        iB3_KLT = Format(.LT, "##")
        ' ç›å…ä«óù
        CisComboKZaiko.Code = .ç›å…ä«óùãÊï™
        CisComboKZaiko.TextGet
        Call B3Comb_KZaiko_Click
        ' ç›å…åWêî
        iB3_KZaiko = CisFun.RSetFld(.ç›å…åWêî, 0, iB3_KZaiko.cFormat)
        ' ç›å…ì˙êî
        iB3_KZaikoDay = CisFun.RSetFld(.ç›å…ì˙êî, 0, iB3_KZaikoDay.cFormat)
        ' ç›å…î≠íçì_
        iB3_KZaikoL = CisFun.RSetFld(.ç›å…î≠íçì_, 0, iB3_KZaikoL.cFormat)
        ' ç≈ëÂç›å…ä«óù
        CisComboKMZaiko.Code = .ç≈ëÂç›å…ä«óùãÊï™
        CisComboKMZaiko.TextGet
        Call B3Comb_KMZaiko_Click
        ' ç≈ëÂç›å…åWêî
        iB3_KMZaiko = CisFun.RSetFld(.ç≈ëÂç›å…åWêî, 0, iB3_KMZaiko.cFormat)
        ' ç≈ëÂç›å…ì˙êî
        iB3_KMZaikoDay = CisFun.RSetFld(.ç≈ëÂç›å…ì˙êî, 0, iB3_KMZaikoDay.cFormat)
        ' ç≈ëÂç›å…î≠íçì_
        iB3_KMZaikoL = CisFun.RSetFld(.ç≈ëÂç›å…î≠íçì_, 0, iB3_KMZaikoL.cFormat)
        ' é˚óeêî
        iB3_KSyuyo = Format(.é˚óeêî, "##,###")
        ' ì˙ïÒ
        B3Chk_Nipo.Value = .ì˙ïÒèoóÕ
        Call B3Chk_Nipo_Click
        ...
        gSL_Select = "SELECT * FROM ïiî‘çHèáÉZÉbÉgïiî‘É}ÉXÉ^ "
        gSL_Select = gSL_Select & " Where ïiî‘ = '" & RTrim(iH1_Hinbn) & "'"
        gSL_Select = gSL_Select & " And   éÊà¯êÊ = '" & RTrim(iB2_Torcd) & "'"
        gSL_Select = gSL_Select & " And   éÛì¸ = '" & RTrim(iB2_Ukeir) & "'"
        If B2Op_Hinmoku(0) Then
        ...
        If HSERead(gSL_Select) Then
           ...
           Do Until Not HSE_RDSTS
              vsGrid4.TextMatrix(mIx, 1) = RTrim(HSE.ÉZÉbÉgïiî‘)
              vsGrid4.TextMatrix(mIx, 2) = Format(HSE.éÊêî, "###")
              
              If mIx = 1 Then
                 iB3_SetHinbn = RTrim(HSE.ÉZÉbÉgïiî‘)
                 iB3_TSu = Format(HSE.éÊêî, "###")
                 Call VSGrid4_Click
              End If
...
'                      æŸåÖêî,óÒî‘çÜ,å©èoÇµì‡óe,ï™óﬁ¿≤Ãﬂ)
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 0, 0, "No")
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 28, 1, "ïiî‘")
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 4, 2, "éÊêî")
'Å@∏ﬁÿØƒﬁëIëèàóùópÅ@ëﬁî¥ÿ±
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç»Çµ, 0, 3, "Select")
'  ï\é¶ ﬂ¿∞›æØƒ
'       Call .PatanSet( ﬂ¿∞›NO,ï\é¶ÉpÉ^Å[Éì)
