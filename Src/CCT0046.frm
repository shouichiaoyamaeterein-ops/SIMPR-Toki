      ...
      Begin Cis3D_v60.CIS3D CIS3D4 
         ...
         Begin Cis3D_v60.CIS3D Back_Detail 
            ...
            Begin VB.Frame Back_020_1 
               ...
               Visible         =   0   'False
               Width           =   2355
               Begin CisText_V60.CisText iB1_Jisya 
                  Height          =   375
                  Left            =   780
                  TabIndex        =   15
                  Top             =   300
            ...
            Begin VB.Frame Back_020_2 
               ...
               Visible         =   0   'False
               Width           =   2355
               Begin CisText_V60.CisText iB1_DelDay 
                  Height          =   375
                  Left            =   780
                  TabIndex        =   16
                  Top             =   300
...
'+----------------------------------------- 2007/03/05 Insert
    '+-------- 財務データ
    If CT0040_TEXTTYPE = 1 Then
       Back_Zaimu.Visible = True
    End If
    '+-------- 手配データ
    If CT0040_TEXTTYPE = 2 Then
       Back_020_1.Visible = True
       Back_020_2.Visible = True
       Back_020_1.Move Back_020_1.Left, Back_Zaimu.Top
       Back_020_2.Move Back_020_2.Left, Back_Zaimu.Top
    End If
'+----------------------------------------- 2007/03/05 Insert End
...
Private Sub BodySet()
    ...
    With TKT
        ...
        iB1_NaijiDel = CisFun.RSetFld(.オプション2, 0, iB1_NaijiDel.cFormat)
    ...
    '+---------------------------------------- 2007/03/05 Insert
        ...
        If CT0040_TEXTTYPE = 2 Then
           iB1_Jisya = .自社CD
           iB1_DelDay = CisFun.RSetFld(.保持期間, 0, iB1_DelDay.cFormat)
        End If
    '+---------------------------------------- 2007/03/05 Insert End
    End With
    With CisFun
...
'    gSL_Select = gSL_Select & " Where 区分名称 = 'レイアウト情報財務'"
...
'        End If
        ...
        '----- 手配データ
        If CT0040_TEXTTYPE = 2 Then
           .保持期間 = CisFun.Val2(iB1_DelDay)
           .自社CD = RTrim(iB1_Jisya)
           .TNSタイプ = 2
        End If
        '+------------------------------------- 2007/03/05 Insert End
