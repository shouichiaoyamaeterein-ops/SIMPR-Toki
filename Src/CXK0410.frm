...
Begin VB.Form CXK0410 
   BackColor       =   &H00808000&
   BorderStyle     =   1  'å≈íË(é¿ê¸)
   Caption         =   "åüé˚èÛãµè∆âÔ"
   ClientHeight    =   11010
   ClientLeft      =   90
   ClientTop       =   1515
   ClientWidth     =   14895
   ...
   Begin Cis3D_v60.CIS3D B2_Area2 
      ...
      Begin vsFlexLib.vsFlexArray VSGrid1 
         ...
         Appearance      =   1
         ConvInfo        =   1418783674
         FormatString    =   "No|î[ì¸ì˙-ï÷|éÛíçêî|èoâ◊ì˙-ï÷|èoâ◊êî|åüé˚ì˙|åüé˚êî|"
         Rows            =   6
         Cols            =   8
         BackColor       =   16777152
      ...
      Begin Cis3D_v60.CIS3D UC_3D12 
         ...
         cBoderStyle     =   1
      End
      Begin Cis3D_v60.CIS3D B2lb_Suryo 
         Height          =   330
         Index           =   0
         Left            =   1485
         Top             =   60
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CXK0410.frx":0000
         Height          =   7710
         Left            =   60
         OleObjectBlob   =   "CXK0410.frx":0015
         TabIndex        =   12
         Top             =   60
         Width           =   14445
      End
   ...
   Begin Cis3D_v60.CIS3D UC_3D31 
      ...
      BackColor       =   14737632
      ForeColor       =   0
      Caption         =   "Å@Å@Å@Åy åüé˚èÛãµè∆âÔ Åz"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ÇlÇr ÉSÉVÉbÉN"
         Size            =   14.25
         Charset         =   128
...
'**       ïœ  çX  ì˙    :  2008/06/11  By CIS - èåèÇ…çHãÊÅAï\é¶Ç…çHãÊñºÅEã‡äzÅ@í«â¡
...
'+---------------------+
    With CisDBGrid
        ...
        .LayOutName = CisFun.WSID & "K0410.Lay"       ' ⁄≤±≥ƒèÓïÒäiî[êÊÅAÃß≤Ÿñº
        .PrintHeadLine = Ç†ÇË
        .PrintBodyLine = Ç†ÇË
        .PrintBodyGyo = 10
...
Private Function Head1Chk() As Boolean
    ...
    If Trim(iH1_SDate) <> "" And Trim(iH1_EDate) <> "" Then
       If iH1_SDate > iH1_EDate Then
            With CisFun
                .MB_Lines = 5
                .MB_MSG(2) = "    åüé˚ì˙Çê≥ÇµÇ≠ì¸óÕÇµÇƒâ∫Ç≥Ç¢         "
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/11 INSERT END
            ...
            If OpH1_DspKbn(1).Value Then
               .Where_Create AlphaMe, "é¿ê—îNåé", "", ìôÇµÇ¢, Create
            End If
            ' é¿ê—çœ
            If OpH1_DspKbn(2).Value Then
               .Where_Create AlphaMe, "é¿ê—îNåé", "", ìôÇµÇ≠Ç»Ç¢, Create
            End If
...
' ⁄≤±≥ƒï\é¶ì‡óeÇÊÇË√ﬁ∞¿òAåãñºÇãÅÇﬂÇÈ
    ...
    gSL_Select = gSL_Select & ",åüé˚ì˙,î[ì¸êÊ,ïiî‘,îwî‘çÜ,"
    gSL_Select = gSL_Select & "î[ì¸î‘çÜ,åüé˚ä«óùNO"
    gSL_Select = gSL_Select & " from åüé˚èÛãµñ‚çáÉrÉÖÅ[ "
...
' Call .GridInitSet(œ∞ºﬁèàóù,ï™óﬁèàóù,√ﬁ∞¿òAåãñº,àÛç¸å©èoÇµ,àÛç¸åÖêî,çáåvàÛç¸)
    With CisDBGrid
         Call .GridInitSet(True, , "ï\é¶åüé˚ì˙", "åü é˚ ì˙", 12)
         Call .GridInitSet(True, , "ï\é¶î[ì¸î‘çÜ", "î[  î‘", 8)
         ...
         Call .GridInitSet(, , "ñáêî", "ñáêî", 6, True)
         Call .GridInitSet(, , "åüé˚êî", "åüé˚êî", 10, True)
         Call .GridInitSet(True, , "ï\é¶é¿ê—îNåé", "é¿ê—îNåé", 7)
         Call .GridInitSet(True, , "ï\é¶ì¸óÕì˙", "ì¸ óÕ ì˙", 12)
         Call .GridInitSet(True, , "é‘å^", "é‘å^", 5)
         Call .GridInitSet(True, , "íuèÍ", "íuèÍ", 11)
         Call .GridInitSet(True, , "ï“èWå_ñÒêÊ", "å_  ñÒ  êÊ", 25)
         Call .GridInitSet(True, , "ïiñº", "ïi        ñº", 40)
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/11 INSERT START
         Call .GridInitSet(True, , "ã‡äz", "ã‡  äz", 13)
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/11 INSERT END
    End With
End Sub
'+----------------------------------------------------------+
...
'                      æŸåÖêî,óÒî‘çÜ,å©èoÇµì‡óe,ï™óﬁ¿≤Ãﬂ)
        ...
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 14, 1, "î[ ì¸ ì˙ - ï÷")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 8, 2, "éÛíçêî")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 14, 3, "èo â◊ ì˙ - ï÷")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 8, 4, "èoâ◊êî")
        Call .FixedSet(íÜíÜ, íÜíÜ, Ç†ÇË, 10, 5, "åü é˚ ì˙")
        Call .FixedSet(íÜíÜ, âEíÜ, Ç†ÇË, 8, 6, "åüé˚êî")
'Å@∏ﬁÿØƒﬁëIëèàóùópÅ@ëﬁî¥ÿ±
'        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç»Çµ, 0, 7, "Select")
'  ï\é¶ ﬂ¿∞›æØƒ
...
' íäèoèàóù èâä˙æØƒ
    ...
    End With
    ' éÛíçèÓïÒ
    gSL_Select = "Select CASE WHEN ISNULL(JY.î[ì¸ì˙,'') = '' THEN"
    gSL_Select = gSL_Select & "        CASE WHEN ISNULL(JY.î[ì¸ï÷,'') = '' THEN ''"
    gSL_Select = gSL_Select & "        ELSE SPACE(10) + '-' + JY.î[ì¸ï÷ END"
    gSL_Select = gSL_Select & "    Else"
    gSL_Select = gSL_Select & "        CASE WHEN ISNULL(JY.î[ì¸ï÷,'') = '' THEN"
    gSL_Select = gSL_Select & "            SUBSTRING(JY.î[ì¸ì˙,1,4) + '/' + SUBSTRING(JY.î[ì¸ì˙,5,2) + '/' +"
    gSL_Select = gSL_Select & "            SUBSTRING(JY.î[ì¸ì˙,7,2)"
    gSL_Select = gSL_Select & "        Else"
    gSL_Select = gSL_Select & "            SUBSTRING(JY.î[ì¸ì˙,1,4) + '/' + SUBSTRING(JY.î[ì¸ì˙,5,2) + '/' +"
    gSL_Select = gSL_Select & "            SUBSTRING(JY.î[ì¸ì˙,7,2) + '- ' + JY.î[ì¸ï÷ END"
    gSL_Select = gSL_Select & "    END oyian,î[ì¸êî rno "
    gSL_Select = gSL_Select & "    From éÛíçÉeÅ[ÉuÉã JY"
    gSL_Select = gSL_Select & " Where JY.ïiî‘ = '" & Adodc1.Recordset("ïiî‘") & "'"
    gSL_Select = gSL_Select & "   And JY.î[ì¸êÊ = '" & Adodc1.Recordset("î[ì¸êÊ") & "'"
    gSL_Select = gSL_Select & "   And JY.éÛì¸ = '" & Adodc1.Recordset("éÛì¸") & "'"
    gSL_Select = gSL_Select & "   And JY.î[ì¸î‘çÜ = '" & Adodc1.Recordset("î[ì¸î‘çÜ") & "'"
    gSL_Select = gSL_Select & "   And JY.ï™î[âÒêî = 0"
    gSL_Select = gSL_Select & " Order By JY.î[ì¸ì˙,JY.î[ì¸ï÷"
    
    Call GridMove(0)
    
    gSL_Select = "Select  CASE WHEN ISNULL(SK.èoâ◊ì˙,'') = '' THEN"
    gSL_Select = gSL_Select & "        CASE WHEN ISNULL(SK.èoâ◊ï÷,'') = '' THEN ''"
    gSL_Select = gSL_Select & "        ELSE SPACE(10) + '-' + SK.èoâ◊ï÷ END"
    gSL_Select = gSL_Select & "    Else"
    gSL_Select = gSL_Select & "        CASE WHEN ISNULL(SK.èoâ◊ï÷,'') = '' THEN"
    gSL_Select = gSL_Select & "            SUBSTRING(SK.èoâ◊ì˙,1,4) + '/' + SUBSTRING(SK.èoâ◊ì˙,5,2) + '/' +"
    gSL_Select = gSL_Select & "            SUBSTRING(SK.èoâ◊ì˙,7,2)"
    gSL_Select = gSL_Select & "        Else"
    gSL_Select = gSL_Select & "            SUBSTRING(SK.èoâ◊ì˙,1,4) + '/' + SUBSTRING(SK.èoâ◊ì˙,5,2) + '/' +"
    gSL_Select = gSL_Select & "            SUBSTRING(SK.èoâ◊ì˙,7,2) + '- ' + SK.èoâ◊ï÷ END"
    gSL_Select = gSL_Select & "    END oyian,èoâ◊êî rno "
    gSL_Select = gSL_Select & "    From éÛíçÉeÅ[ÉuÉã JY"
    ...
    gSL_Select = gSL_Select & "   And JY.éÛì¸ = '" & Adodc1.Recordset("éÛì¸") & "'"
    gSL_Select = gSL_Select & "   And JY.î[ì¸î‘çÜ = '" & Adodc1.Recordset("î[ì¸î‘çÜ") & "'"
    gSL_Select = gSL_Select & "   And Isnull(SK.èoâ◊ì˙,'') <> ''"
    gSL_Select = gSL_Select & " Order By SK.èoâ◊ì˙,SK.èoâ◊ï÷"
    
    Call GridMove(1)
    
    gSL_Select = "Select "
    gSL_Select = gSL_Select & "    SUBSTRING(åüé˚ì˙,1,4) + '/' + SUBSTRING(åüé˚ì˙,5,2) + '/' +"
    gSL_Select = gSL_Select & "    SUBSTRING(åüé˚ì˙,7,2)"
    gSL_Select = gSL_Select & "    oyian , åüé˚êî rno, åüé˚ä«óùNo åèêî"
    gSL_Select = gSL_Select & "    From åüé˚ÉeÅ[ÉuÉã"
    ...
    gSL_Select = gSL_Select & "   And î[ì¸î‘çÜ = '" & Adodc1.Recordset("î[ì¸î‘çÜ") & "'"
    gSL_Select = gSL_Select & " Order By åüé˚ì˙"
    Call GridMove(2)
    ...
    GridSet = mSetFlg
End Function
Private Sub GridMove(SetType As Long)
    
    B2lb_Suryo(SetType) = ""
    
    If IRNRead(gSL_Select) Then
        If CisDB.RecordCount + 1 < VSGrid1.Rows Then
'            VSGrid1.Rows = CisVsGrid.DispMax
        Else
            VSGrid1.Rows = CisDB.RecordCount + 1
        End If
        gCnt2 = 0
        If SetType = 2 And CisDB.RecordCount > 1 Then
           mSetFlg = True
        End If
        ...
        Do Until Not IRN_RDSTS
           With VSGrid1
                gCnt2 = gCnt2 + 1
                'ì˙ït
                .TextMatrix(gCnt2, 1 + (SetType * 2)) = IRN.oyian
                'êîó 
                .TextMatrix(gCnt2, 2 + (SetType * 2)) = Format(IRN.rno, "#,###")
                If SetType = 2 Then
                   If Adodc1.Recordset("åüé˚ä«óùNO") = IRN.åèêî Then
                      .Row = gCnt2
                      .Col = 5: .CellBackColor = &HFFC0C0
                      .Col = 6: .CellBackColor = &HFFC0C0
                   End If
                Else
                   mSetFlg = True
                End If
                B2lb_Suryo(SetType) = Format(CisFun.Val2(B2lb_Suryo(SetType)) + IRN.rno, "#,###")
            End With
...
Private Sub TotalDsp(JCol As Long)
    ...
    gSL_Select = "Select Sum(åüé˚êî ),Sum(ñáêî),"
    ...
    Select Case JCol
      Case -1
           wWhere = ""
      Case 0, 1, 2, 3, 4, 9, 10, 11, 12, 13
           ' åüé˚ì˙(0),î[ì¸î‘çÜ(1),ïiî‘(2),îwî‘çÜ(3),î[ì¸êÊ(4),é¿ê—îNåé(9),ì¸óÕì˙(10),
           ' é‘å^(11),íuèÍ(12),å_ñÒêÊ(13)
...
'           wMsg = DBGrid1.Columns(JCol).Caption
'           wValue = DBGrid1.Columns(JCol).Text
'           wWhere = "î[ì¸î‘çÜ = '" & Adodc1.Recordset("î[ì¸î‘çÜ") & "'"
      Case 5            ' î[ì¸êÊ•éÛì¸
           wMsg = "î[ì¸êÊ•éÛì¸"
    ...
    With CisDB
        ...
        If .DBRead(1, 0) Then
            ...
            lb_THMSu = Format(.Recordset(1), "###,##0")
            lb_SKensu = " Åy èWåvåèêî ÅÅ " & Format(.Recordset(2), "###,##0") & " Åz"
        Else
