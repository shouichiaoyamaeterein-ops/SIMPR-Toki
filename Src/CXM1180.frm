...
Private Sub PB_Prt_Click()
    ...
    With CisSimplePrint
        ...
        .pHeadItemSet 0, 中, "№"
        .pHeadItemSet 1, 中, "仕　入  先"
        .pHeadItemSet 2, 中, "品  番"
        .pHeadItemSet 3, 中, "入 荷 日"
        ...
        For gInt = 1 To .MaxCount
            ...
            .pBodyValueSet 5, vsGrid1.TextMatrix(gInt, CisVsGrid.FixedGet(6))
...
Private Function Head1Chk() As Boolean
    ...
    If Not TankaProc Then
       ...
       Exit Function
    End If
    gSL_Select = "SELECT HN.表示品番,TW.取引先,TW.契約先,"
    ...
    gSL_Select = gSL_Select & " GROUP BY TW.取引先,HN.表示品番,TW.契約先,TW.品番,TR.略称"
    gSL_Select = gSL_Select & " Order By TW.取引先,TW.品番,TW.契約先"
...
'                      ｾﾙ桁数,列番号,見出し内容,分類ﾀｲﾌﾟ)
        ...
        Call .FixedSet(中中, 左中, あり, 28, 2, "仕　入  先")
        Call .FixedSet(中中, 左中, あり, 24, 3, "品       番")
        Call .FixedSet(中中, 左中, あり, 26, 4, "入　荷　日")
        Call .FixedSet(中中, 右中, あり, 10, 5, "数量合計")
        Call .FixedSet(中中, 中中, あり, 7, 6, "契約先")

        Call .FixedSet(中中, 右中, あり, 0, 7, "納入先CD")
        Call .FixedSet(中中, 右中, あり, 0, 8, "品番CD")
'　ｸﾞﾘｯﾄﾞ選択処理用　退避ｴﾘｱ
    ...
    With vsGrid1
       .Redraw = False
        ...
        Do Until Not TMW_RDSTS
            ...
            .TextMatrix(ID, GridCol(6)) = TMW.契約先
            .TextMatrix(ID, GridCol(7)) = TMW.取引先
            .TextMatrix(ID, GridCol(8)) = TMW.品番
            '納入先
            gStr = TMW.取引先
...
Private Sub CallProc()
    With vsGrid1
        ...
        RV_Torcd = Trim(.TextMatrix(.Row, CisVsGrid.FixedGet(7)))
        RV_Hinbn = Trim(.TextMatrix(.Row, CisVsGrid.FixedGet(8)))
        RV_KTorcd = Trim(.TextMatrix(.Row, CisVsGrid.FixedGet(6)))
