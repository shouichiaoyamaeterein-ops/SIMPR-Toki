...
'**       変  更  日    :   2009/09/24  By CIS 手入力時､品番マスタ検索
'**
'**********************************************************'
...
'    Call QRConvert(QT10QSR_ReadData)
    wStr = QT10QSR_ReadData
    If QRConvert(QT10QSR_ReadData) = "対象外データ" Then
        With CisFun
             .MB_Lines = 5
             .MB_MSG(2) = "  対象外伝票です      "
             .MB_Title = ""
