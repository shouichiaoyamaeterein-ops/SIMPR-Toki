...
'**       変  更  日    :   2008/06/18  By CIS 千代田工業用カスタマイズ
'**
'**********************************************************'
...
'    Kn_Jisya = RTrim(gCompany)
    ...
    CKNZ1230_JisyaNM = ""
    CKNZ1230_JisyaKJNM = ""
    CKNZ1230_Jisya = RTrim(gCompany)
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/18 UPDATE END
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/18 UPDATE START
    ...
    CKNZ1230_Jisya = CKNZ1230_Jisya & RTrim(IRN.oyian)
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/18 UPDATE END
...
'       Kn_JisyaKJNM = TRM.工場名
    gSL_Select = gSL_Select & "   AND 取引先CD = '" & CKNZ1230_Jisya & "'"
    If TRMRead(gSL_Select, 1) Then
       CKNZ1230_JisyaNM = TRM.略称
       CKNZ1230_JisyaKJNM = TRM.工場名
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/18 UPDATE END
    End If
...
'                    .自社名2 = CisFun.Mid2(Kn_JisyaKJNM, 1, 14)
                    .自社CD = CKNZ1230_Jisya
                    .自社名1 = CisFun.Mid2(CKNZ1230_JisyaNM, 1, 20)
                    .自社名2 = CisFun.Mid2(CKNZ1230_JisyaKJNM, 1, 14)
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/18 UPDATE END
                    .作成者 = gTanto
