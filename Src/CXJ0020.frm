...
Begin VB.Form CXJ0020 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin Cis3D_v60.CIS3D CIS3D6 
         ...
         Begin Cis3D_v60.CIS3D CIS3D7 
            ...
            cPositionY      =   30
         End
         Begin CisText_V60.CisText CisText5 
            Height          =   360
            Left            =   1740
            TabIndex        =   34
            Top             =   60
   ...
   Begin VB.PictureBox PNL_PF 
      ...
      End
      Begin CisBtn_60.CisBtn CisBtn1 
         Height          =   585
         Left            =   3435
         Top             =   60
         Width           =   825
   ...
   Begin VB.PictureBox H1_Area2 
      ...
      Begin Cis3D_v60.CIS3D CIS3D13 
         ...
         cAlingnment     =   6
         cPositionY      =   30
         Begin CisText_V60.CisText CisText9 
            Height          =   360
            Left            =   75
            TabIndex        =   22
            Top             =   330
         ...
         Begin Cis3D_v60.CIS3D CIS3D14 
            ...
            cPositionY      =   30
         End
         Begin CisText_V60.CisText CisText10 
            Height          =   360
            Left            =   660
            TabIndex        =   23
            Top             =   330
      ...
      Begin Cis3D_v60.CIS3D CIS3D16 
         ...
         cAlingnment     =   6
         cPositionY      =   30
         Begin CisText_V60.CisText CisText11 
            Height          =   360
            Left            =   180
            TabIndex        =   24
            Top             =   330
      ...
      Begin Cis3D_v60.CIS3D CIS3D18 
         ...
         cAlingnment     =   6
         cPositionY      =   30
         Begin CisText_V60.CisText CisText12 
            Height          =   360
            Left            =   300
            TabIndex        =   25
            Top             =   330
         ...
         Begin Cis3D_v60.CIS3D CIS3D19 
            ...
            cPositionY      =   30
         End
         Begin CisText_V60.CisText CisText13 
            Height          =   360
            Left            =   1230
            TabIndex        =   26
            Top             =   330
      ...
      Begin Cis3D_v60.CIS3D UC_3D4 
         ...
         Begin Cis3D_v60.CIS3D BLB_DD 
            ...
            Begin vsFlexLib.vsFlexArray vsGrid 
               ...
               Appearance      =   1
               ConvInfo        =   1418783674
               FormatString    =   "№ |背番号|品　番　　　　　 　　　　 |収容数 |枚　数|端　数  |発注数   　|"
               Rows            =   11
               Cols            =   20
               BackColor       =   12648384
               ...
               Begin Cis3D_v60.CIS3D CIS3D20 
                  ...
                  cFont3DColor2   =   8421504
                  cBoderStyle     =   1
                  Begin CisText_V60.CisText CisText14 
                     Height          =   360
                     Left            =   0
                     TabIndex        =   27
                     Top             =   0
                     ...
                     MaxLength       =   5
                  End
                  Begin CisText_V60.CisText CisText15 
                     Height          =   360
                     Left            =   795
                     TabIndex        =   28
                     Top             =   0
                     ...
                     MaxLength       =   25
                  End
                  Begin CisText_V60.CisText CisText17 
                     Height          =   360
                     Left            =   4920
                     TabIndex        =   29
                     Top             =   0
                  ...
                  Begin Cis3D_v60.CIS3D CIS3D21 
                     ...
                     cPositionX      =   -50
                  End
                  Begin CisText_V60.CisText CisText16 
                     Height          =   360
                     Left            =   5760
                     TabIndex        =   30
                     Top             =   0
                     ...
                     cILength        =   6
                  End
                  Begin CisText_V60.CisText CisText18 
                     Height          =   360
                     Left            =   6795
                     TabIndex        =   31
                     Top             =   0
   ...
   Begin Cis3D_v60.CIS3D CIS3D8 
      ...
      Begin Cis3D_v60.CIS3D CIS3D9 
         ...
         Begin vsFlexLib.vsFlexArray vsFlexArray1 
            ...
            Appearance      =   1
            ConvInfo        =   1418783674
            FormatString    =   "№ | 区分  |分納|SK区分|受注区分|納品書№|納入先                 |納入日       |事業所|納入場所|機番|#|支給元|ページ"
            Rows            =   8
            Cols            =   14
            BackColor       =   12648447
            RowHeightMin    =   330
...
'発注区分 = 通常の時、
    ...
    End If
'仕入先打切の存在有無
    gSL_Select = "SELECT * FROM 発注打切テーブル"
    gSL_Select = gSL_Select & " WHERE 仕入先 = '" & RTrim(iH1_Torcd) & "'"
    gSL_Select = gSL_Select & "   AND 打切種別 = 3"
    If HUTRead(gSL_Select, 1) Then
        lb_UYmd = Left(HUT.打切日, 4) & "/" & Mid(HUT.打切日, 5, 2) & "/" & Mid(HUT.打切日, 7, 2)
        Back_UYmd.Visible = True
        If RTrim(HUT.打切日) <= RTrim(iH1_Ymd) Then
            With CisFun
                .MB_Lines = 4
                .MB_MSG(2) = "    仕入先が打切済です！            "
                .MB_Title = ""
...
' マスタ入力 SELECT文 ｾｯﾄ
    gSL_Select = " SELECT * "
    gSL_Select = gSL_Select & " FROM 発注画面入力ワーク "
...
'                If RTrim(.TextMatrix(gCnt1, 1)) = RTrim(.TextMatrix(gCnt2, 1)) And
        ...
        '<< 品番取引先マスタ存在チェック >>
            ...
            If OpH1_HKbn(1).Tag = "5" And HTM.SK区分 <> 1 Then
                ...
                GoTo Body1Chk_Err
            End If
            .TextMatrix(gCnt1, 10) = HTM.手配区分
            .TextMatrix(gCnt1, 11) = HTM.SK区分
            .TextMatrix(gCnt1, 12) = HTM.サイクル
            .TextMatrix(gCnt1, 13) = HTM.契約先
        ...
        '<< 発注数チェック >>
            ...
            End If
        '<< 発注打切チェック >>
            iB1_Hinbn = RTrim(.TextMatrix(gCnt1, 2))
            gStr = HUchikiri_Set
            If RTrim(gStr) = "E" Then
                ...
                GoTo Body1Chk_Err
            End If
            If RTrim(gStr) = "1" And HUT.設定残数 < CisFun.Val2(vsGrid.TextMatrix(gCnt1, 6)) Then
...
'納入日・便を求める
    With CisDB
        ...
        .ParaNo = 3: .ParaValue = RTrim(HTM.サイクル)
...
'
        ...
        Else
            ...
            .ParaNo = 10
            vsGrid.TextMatrix(gCnt1, 8) = .ParaValue
            mNYmd = .ParaValue
            .ParaNo = 11
            vsGrid.TextMatrix(gCnt1, 9) = .ParaValue
            mNBin = .ParaValue
        End If
    End With
'
...
Private Function DBInput(InputKey As String) As Boolean
    ...
    If Not HGWRead(gSL_Select, 0, 1) Then
        Call HGWClose
        ...
        If RTrim(vsGrid.TextMatrix(gIndex, 2)) <> "" Then
            ...
            With HGW
                ...
                Else
                    .発注日 = RTrim(iH1_Ymd)
                    .発注便 = RTrim(iH1_Bin)
                    .納入日 = RTrim(vsGrid.TextMatrix(gIndex, 8))
                    .納入便 = RTrim(vsGrid.TextMatrix(gIndex, 9))
                End If
                .品番 = RTrim(vsGrid.TextMatrix(gIndex, 2))
                .背番号 = RTrim(vsGrid.TextMatrix(gIndex, 1))
                .手配区分 = RTrim(vsGrid.TextMatrix(gIndex, 10))
                .SK区分 = CisFun.Val2(vsGrid.TextMatrix(gIndex, 11))
...
'打切の存在有無
    ...
    If HUTRead(gSL_Select, 1) Then
        If HUT.打切種別 = 0 Then
            '残数設定
            If RTrim(HUT.完了日) = "" Then
                B1lb_UZanSu = Format(HUT.設定残数, "#,###")
                HUchikiri_Set = "1"
            Else
                B1lb_UZanSu = "完" & Mid(HUT.完了日, 5, 2) & "/" & Mid(HUT.完了日, 7, 2)
                HUchikiri_Set = "E"
            End If
        Else
            '品番設定
            B1lb_UZanSu = Mid(HUT.打切日, 3, 2) & "/" & Mid(HUT.打切日, 5, 2) & "/" & Mid(HUT.打切日, 7, 2)
            If RTrim(OpH1_HKbn(1).Tag) <> "1" Then
                If RTrim(HUT.打切日) <= RTrim(iH1_Ymd) Then
                    HUchikiri_Set = "E"
                End If
            Else
                If RTrim(HUT.打切日) <= RTrim(mNYmd) Then
                    HUchikiri_Set = "E"
                End If
            End If
        End If
   ...
   '品番・仕入先設定
    ...
    gSL_Select = gSL_Select & " WHERE 品番 = '" & RTrim(iB1_Hinbn) & "'"
    gSL_Select = gSL_Select & "   AND 仕入先 = '" & RTrim(iH1_Torcd) & "'"
    gSL_Select = gSL_Select & "   AND 打切種別 = 2"
    If HUTRead(gSL_Select, 1) Then
        B1lb_UZanSu = Mid(HUT.打切日, 3, 2) & "/" & Mid(HUT.打切日, 5, 2) & "/" & Mid(HUT.打切日, 7, 2)
        If RTrim(OpH1_HKbn(1).Tag) <> "1" Then
            If RTrim(HUT.打切日) <= RTrim(iH1_Ymd) Then
...
'                      ｾﾙ桁数,列番号,見出し内容,分類ﾀｲﾌﾟ)
        ...
        Call .FixedSet(中中, 右中, なし, 9, 7, "打切残数")
'　ｸﾞﾘｯﾄﾞ選択処理用　退避ｴﾘｱ
        Call .FixedSet(中中, 左中, なし, 0, 8, "納入日")
        Call .FixedSet(中中, 左中, なし, 0, 9, "納入便")
        Call .FixedSet(中中, 左中, なし, 0, 10, "手配区分")
        Call .FixedSet(中中, 左中, なし, 0, 11, "SK区分")
        Call .FixedSet(中中, 左中, なし, 0, 12, "サイクル")
...
' ｸﾞﾘｯﾄﾞ行再ｾｯﾄ & 列位置取得
    ...
    Do Until Not HGW_RDSTS
        ...
        With vsGrid
            ...
            .TextMatrix(ID, GridCol(1)) = RTrim(HGW.背番号)
            .TextMatrix(ID, GridCol(2)) = RTrim(HGW.品番)
            .TextMatrix(ID, GridCol(3)) = Format(HGW.収容数, "#,###")
            .TextMatrix(ID, GridCol(4)) = Format(HGW.枚数, "#,###")
            .TextMatrix(ID, GridCol(5)) = Format(HGW.端数, "#,###")
            .TextMatrix(ID, GridCol(6)) = Format(HGW.発注数, "#,###")
            iB1_Hinbn = RTrim(HGW.品番)
            Call HUchikiri_Set
            .TextMatrix(ID, GridCol(7)) = RTrim(B1lb_UZanSu)
        End With
        Call HGWReadNext(1)
    Loop
...
Private Sub TextToVsGrid(tRow As Integer)
    With vsGrid
        ...
        If IsNumeric(B1lb_UZanSu) Then
            .TextMatrix(tRow, 7) = Format(CisFun.Val2(B1lb_UZanSu), "#,###")
        Else
            .TextMatrix(tRow, 7) = RTrim(B1lb_UZanSu)
        End If
    End With
End Sub
'==========================================================='
...
Private Sub VsGridToText(tRow As Integer)
    With vsGrid
        ...
        '打切残数
        If IsNumeric(.TextMatrix(tRow, 7)) Then
            B1lb_UZanSu = Format(CisFun.Val2(.TextMatrix(tRow, 7)), "#,###")
        Else
            B1lb_UZanSu = RTrim(.TextMatrix(tRow, 7))
        End If
    End With
End Sub
...
Private Sub VSGrid_DblClick()
    ...
    iB1_Maisu = "": iB1_HSuryo = "": B1lb_Hasu = "": B1lb_UZanSu = ""
    Call TextToVsGrid(Val(Input_Area.Tag))
