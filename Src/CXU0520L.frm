VERSION 5.00
Begin VB.Form CXU0520L 
   Caption         =   "ìæà”êÊï îÑè„é¿ê—"
   ClientHeight    =   5490
   ClientLeft      =   -750
   ClientTop       =   4020
   ClientWidth     =   15420
   ...
   Begin VB.Label H1_Title 
      AutoSize        =   -1  'True
      Caption         =   "Å¶ YYYYîNMMåéìx ìæà”êÊï îÑè„é¿ê— Å¶"
      BeginProperty Font 
         Name            =   "ÇlÇr ñæí©"
         Size            =   18
         Charset         =   128
...
'    If Not DataRead Then Exit Sub
    ...
    With CisPrt
        .iPrtTitle = "ìæà”êÊï îÑè„é¿ê—àÍóóï\"
        .iLineMax = 30
        .iLinePitch = 5
        .iPaperSize = p_A4
...
'    Call SKTRead(CXU0520_SQL1)
    Call SKTRead(CXU0520_SQL3)              '2009/02/10
    ...
    Do Until Not SKT_RDSTS
        With SKT
            ...
            GKeiYs = GKeiYs + SKT.ó\ë™ã‡äz
            GKeiJs = GKeiJs + SKT.é¿ê—ã‡äz
            GKeiMD1 = GKeiMD1 + SKT.é¿ê—ã‡äz0
            GKeiMD2 = GKeiMD2 + SKT.é¿ê—ã‡äz1
            GKeiMD3 = GKeiMD3 + SKT.é¿ê—ã‡äz2
            GKeiMD4 = GKeiMD4 + SKT.é¿ê—ã‡äz3
            GKeiMD5 = GKeiMD5 + SKT.é¿ê—ã‡äz4
            GKeiMD6 = GKeiMD6 + SKT.é¿ê—ã‡äz5
            GKeiDA = GKeiDA + SKT.ì˙ìñÇËêî
    ...
    '+------------ çHèÍï îÑè„é¿ê— -------------+
'Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢ 2009/02/12 UPDATE START
    'Call SKTRead(CXU0520_SQL2)
    Call SKTRead(CXU0520_SQL4)
'Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢ 2009/02/12 UPDATE END
    Do Until Not SKT_RDSTS
       With SKT
            Call HeadWrite
            
            B1_KojoNM = "       " & SKT.é©é–çHãÊñº
...
'
    ...
    With CisPrt
        ...
        With CisFun
            H1_Title = "Å¶ " & .Mid2(CXU0520_YM, 1, 4) & "îN" & .Mid2(CXU0520_YM, 5, 2) & "åéìx ìæà”êÊï îÑè„é¿ê— Å¶"
            H1_YS = .Mid2(CXU0520_YM, 5, 2) & "åéìxó\ë™"
            H1_JS = .Mid2(CXU0520_YM, 5, 2) & "åéìxé¿ê—"
            H1_MD1 = CXU0520_MD1
            H1_MD2 = CXU0520_MD2
            H1_MD3 = CXU0520_MD3
            H1_MD4 = CXU0520_MD4
