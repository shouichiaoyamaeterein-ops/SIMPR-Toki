...
Begin VB.Form CTA0410 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CZA0410 - コピー.frx":0000
         Height          =   7740
         Left            =   45
         OleObjectBlob   =   "CZA0410 - コピー.frx":0015
         TabIndex        =   5
         Top             =   45
         Width           =   14955
      End
   ...
   Begin VB.PictureBox H1_Area1 
      ...
      Begin Cis3D_v60.CIS3D CIS3D1 
         ...
         Begin VB.ComboBox H1Comb_KakoDo 
            ...
            EndProperty
            Height          =   345
            ItemData        =   "CZA0410 - コピー.frx":157C5
            Left            =   960
            List            =   "CZA0410 - コピー.frx":157C7
...
'' 初期表示時、条件文作成(Where)
  ...
  ''gSL_Select = gSL_Select & vbCrLf & wSQLW
    ...
    gSL_Select = gSL_Select & vbCrLf & "          YK.置場    , YK.担当者"
...
DBInput_Ed:
    ...
    '=======================' 2019/07/09 DEL START：エラーになるので外す（Win7から？原因不明）
'    SendKeys "{END}"
'    SendKeys "{RIGHT}"
'    SendKeys "{LEFT}"
'    SendKeys "{HOME}"
