...
Begin VB.Form COKZ0520 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin vsFlexLib.vsFlexArray VSGrid1 
         ...
         Appearance      =   1
         ConvInfo        =   1418783674
         FormatString    =   $"COKZ0520.frx":0000
         Rows            =   21
         Cols            =   13
         BackColor       =   12648447
      ...
      Begin vsFlexLib.vsFlexArray VsGrid2 
         ...
         Appearance      =   1
         ConvInfo        =   1418783674
         FormatString    =   $"COKZ0520.frx":0091
         Rows            =   4
         Cols            =   11
         FixedRows       =   0
         FixedCols       =   0
...
Private Sub PB_PRT_Click()
    COKZ0520_YM = CisFun.Mid2(iH1_YMD, 1, 6)
    COKZ0520_MD1 = GTitleDay(0)
    COKZ0520_MD2 = GTitleDay(1)
    COKZ0520_MD3 = GTitleDay(2)
    COKZ0520_MD4 = GTitleDay(3)
    COKZ0520_MD5 = GTitleDay(4)
    COKZ0520_MD6 = GTitleDay(5)
...
'Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢ 2009/02/12 INSERT START
    COKZ0520_SQL4 = " SELECT é©é–çHãÊ, é©é–çHãÊñº, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & ") é¿ê—ã‡äz0," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)) & ") é¿ê—ã‡äz1," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)) & ") é¿ê—ã‡äz2," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)) & ") é¿ê—ã‡äz3," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)) & ") é¿ê—ã‡äz4," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & ") é¿ê—ã‡äz5," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        CASE WHEN SUM(ó\ë™ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "             CASE WHEN SUM(é¿ê—ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "                  ROUND(SUM(é¿ê—ã‡äz) / SUM(ó\ë™ã‡äz) * 100, 1)" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        END  END êiíª," & vbCrLf
    If wKadou = 0 Then
       COKZ0520_SQL4 = COKZ0520_SQL4 & "        0 ì˙ìñÇËêî"
    Else
       COKZ0520_SQL4 = COKZ0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COKZ0520_SQL4 = COKZ0520_SQL4 & "   FROM ("
    
    COKZ0520_SQL4 = COKZ0520_SQL4 & " SELECT é©é–çHãÊ, ISNULL(SY.ílñºèÃ, '') é©é–çHãÊñº, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & "," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)) & "," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)) & "," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)) & "," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)) & "," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & "," & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        CASE WHEN SUM(ó\ë™ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "             CASE WHEN SUM(é¿ê—ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "                  ROUND(SUM(é¿ê—ã‡äz) / SUM(ó\ë™ã‡äz) * 100, 1)" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        END  END êiíª," & vbCrLf
    ...
    Else
       COKZ0520_SQL4 = COKZ0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COKZ0520_SQL4 = COKZ0520_SQL4 & "   FROM îÉä|ì¸â◊èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        LEFT OUTER JOIN ñºèÃÉ}ÉXÉ^ SY"
    COKZ0520_SQL4 = COKZ0520_SQL4 & "             ON SY.ãÊï™ñºèÃ = 'é©é–çHãÊ'"
    COKZ0520_SQL4 = COKZ0520_SQL4 & "            AND SY.íl = é©é–çHãÊ"
    COKZ0520_SQL4 = COKZ0520_SQL4 & "            AND SY.ãÊï™É^ÉCÉv = ''"
    COKZ0520_SQL4 = COKZ0520_SQL4 & wWhereS & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "  GROUP BY é©é–çHãÊ, SY.ílñºèÃ" & vbCrLf
    
    COKZ0520_SQL4 = COKZ0520_SQL4 & " UNION" & vbCrLf
    ...
    Else
       COKZ0520_SQL4 = COKZ0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COKZ0520_SQL4 = COKZ0520_SQL4 & "   FROM îÉä|ì‡é¶èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "        LEFT OUTER JOIN ñºèÃÉ}ÉXÉ^ SY"
    COKZ0520_SQL4 = COKZ0520_SQL4 & "             ON SY.ãÊï™ñºèÃ = 'é©é–çHãÊ'"
    COKZ0520_SQL4 = COKZ0520_SQL4 & "            AND SY.íl = é©é–çHãÊ"
    COKZ0520_SQL4 = COKZ0520_SQL4 & "            AND SY.ãÊï™É^ÉCÉv = ''"
    COKZ0520_SQL4 = COKZ0520_SQL4 & wWhereN & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & "  GROUP BY é©é–çHãÊ, SY.ílñºèÃ) SY" & vbCrLf
    
    COKZ0520_SQL4 = COKZ0520_SQL4 & "  GROUP BY é©é–çHãÊ, é©é–çHãÊñº" & vbCrLf
    COKZ0520_SQL4 = COKZ0520_SQL4 & " ORDER BY é©é–çHãÊ" & vbCrLf
