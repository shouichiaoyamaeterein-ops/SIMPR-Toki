VERSION 5.00
Begin VB.Form CTP3110L 
   Caption         =   "eÇ©ÇÒÇŒÇÒéÛíçïœä∑ÉäÉXÉg"
   ClientHeight    =   2265
   ClientLeft      =   450
   ClientTop       =   3210
   ClientWidth     =   16755
   ...
   Begin VB.Label Label34 
      AutoSize        =   -1  'True
      Caption         =   "Å¶Å¶ eÇ©ÇÒÇŒÇÒéÛíçïœä∑ÉäÉXÉg Å¶Å¶"
      BeginProperty Font 
         Name            =   "ÇlÇr ñæí©"
         Size            =   18
         Charset         =   128
...
'**********************************************************'
'**
'**       ÉtÉHÅ[ÉÄñº    :  êVeÇ©ÇÒÇŒÇÒéÛíçïœä∑ÉäÉXÉg
'**       ÉtÉHÅ[ÉÄID    :  CTP3110L
'**       èàóùäTóv      :
'**
'**       çÏ  ê¨  ì˙    :  2005/11/25
...
Private Sub Form_Load()
    ...
    '*---------------------*
    With eKanban_Prt
        .iPrtTitle = "êVeÇ©ÇÒÇŒÇÒéÛíçïœä∑ÉäÉXÉg"
        .iLineMax = 40
        .iPaperSize = p_A4
