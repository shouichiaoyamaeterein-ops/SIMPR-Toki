...
'Call Test_LogOutput(wcc_Body & vbCrLf & wcc_Body2)     ' (確認用)

    sv_Uke2 = ""
    sv_NOTor = ""

    With CisDB
        .SQL = "受注SIM納品書チェック_ナルコ"   ' 2009.09.10 upd
        .StoadoCount = 11
...
Private Sub PDQComm1_OnComm()
    ...
    If Mid(QT10QSR_ReadData, 1, 7) <> "SIMPR-A" Then
        ...
        Exit Sub
    End If
    If Mid(QT10QSR_ReadData, 8, 4) <> "5002" Then
        With CisFun
             .MB_Lines = 5
             .MB_MSG(2) = "  対象外伝票です      "
             .MB_Title = ""
