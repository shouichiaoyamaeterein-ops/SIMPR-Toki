...
Begin VB.Form CXHZ0011 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CXHZ0011.frx":0000
         Height          =   5550
         Left            =   90
         OleObjectBlob   =   "CXHZ0011.frx":0015
         TabIndex        =   2
         Top             =   60
         Width           =   9075
      End
...
Private Function BodySet() As Boolean
    ...
    gSL_Select = gSL_Select & " FROM 材料発注画面入力ワーク HG "
