...
'**       変　更  日    :   2011/12/28  By CIS  作業報告テーブル,工順条件中止
...
'    PNL_PF.Enabled = False
    ...
    '生産負荷表示ワーク削除
    gSL_Select = ""
    gSL_Select = gSL_Select & "Delete from 生産負荷表示ワーク " & Chr(13)
    gSL_Select = gSL_Select & " Where 作成端末 = HOST_NAME()" & Chr(13)
...
'''    gSL_Select = gSL_Select & "            AND HKM.工順   = SNT.工順" & Chr(13)              '2011/12/28
    If RTrim(iH1_EDate) = "" Then
    ...
    '表示データ作成
    gSL_Select = ""
    gSL_Select = gSL_Select & "INSERT INTO 生産負荷表示ワーク " & Chr(13)
    gSL_Select = gSL_Select & " ( 作成端末,部門,機械,ﾛﾎﾞｯﾄ区分,機械NO,工程,種別,数量,表示工程数,基準時間,ワーク部門," & Chr(13)
    gSL_Select = gSL_Select & " ワーク機械,ワークロボット,ワーク機械NO,ワーク工程,ワーク種別,ワーク工程数 )" & Chr(13)
    gSL_Select = gSL_Select & " Select SUBSTRING(HOST_NAME(),1,20), " & Chr(13)
...
'''    gSL_Select = gSL_Select & "                       AND HK.工順   = SN.工順" & Chr(13)             '2011/12/28
    If RTrim(iH1_EDate) = "" Then
    ...
    gSL_Select = gSL_Select & "    部門,機械,ﾛﾎﾞｯﾄ区分,機械NO,工程,種別, "
    gSL_Select = gSL_Select & "    ISNULL(SUM(数量),0) 数量,ISNULL(SUM(表示工程数),0) 表示工程数,ISNULL(SUM(基準時間),0) 基準時間, "
    gSL_Select = gSL_Select & "    ワーク部門,ワーク機械,ワークロボット "
'    gSL_Select = gSL_Select & "    ,ワーク機械NO,ワーク工程,ワーク種別,ワーク工程数 "
    gSL_Select = gSL_Select & "    ,ワーク機械NO,ワーク工程,ワーク種別 "
    gSL_Select = gSL_Select & "FROM "
    gSL_Select = gSL_Select & "( SELECT DISTINCT  作成端末,部門,機械,ﾛﾎﾞｯﾄ区分,機械NO,工程,種別,ワーク部門,ワーク機械,ワークロボット, "
    gSL_Select = gSL_Select & "                   数量,表示工程数,基準時間,  "
    gSL_Select = gSL_Select & "                   ワーク機械NO,ワーク工程,ワーク種別,ワーク工程数 "
    gSL_Select = gSL_Select & "                FROM  生産負荷表示ワーク "
    ...
    gSL_Select = gSL_Select & "    部門,機械,ﾛﾎﾞｯﾄ区分,機械NO,工程,種別,ワーク部門,ワーク機械,ワークロボット "
'    gSL_Select = gSL_Select & "    ,ワーク機械NO,ワーク工程,ワーク種別,ワーク工程数 "
    gSL_Select = gSL_Select & "    ,ワーク機械NO,ワーク工程,ワーク種別 "
    gSL_Select = gSL_Select & "ORDER BY ワーク部門,ワーク機械,ワークロボット"
    gSL_Select = gSL_Select & "    ,ワーク機械NO,ワーク工程,ワーク種別 "
