...
Begin VB.Form CXU0525 
   BorderStyle     =   1  '固定(実線)
   Caption         =   "得意先別売上実績表 印刷"
   ClientHeight    =   2625
   ClientLeft      =   6270
   ClientTop       =   5850
   ClientWidth     =   5265
...
Private Sub ReturnPress()
    ...
    CXU0520_PrtCnt = CisDB.RecordCount
    CXU0520_Kara = False
    Set CisPrt = New CISFormPrint
    
'   出力先
    lb_msg.Caption = "【 得意先別売上実績表 印刷中 】"
    DoEvents
    With CisPrt
         Set .iPrtForm = CXU0520L
         .dpMSG = "得意先別売上実績表　印刷中"
