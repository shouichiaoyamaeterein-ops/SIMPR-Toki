...
'*---------------------------------*
    MaxGyo = 3: GGyo = 0
    Call CisPrtCXHZ0340.ClrLstFld("B1")
    Call HeadWrite(0)
...
'*---------------------------------*
    Do Until Not ZCT_RDSTS
        ...
        '*---------------------------------*
            ...
            'QR
                ...
                B1_QRmaker1.Refresh
            'BODY部印刷
                Call CisPrtCXHZ0340.PrintFld("B1*")
                CisPrtCXHZ0340.cLine = CisPrtCXHZ0340.cLine + 23
                Call CisPrtCXHZ0340.ClrLstFld("B1")
                ...
                With CisPrtCXHZ0340
                    .cDataCnt = .cDataCnt + 1
                    .dpCountDisp Format(.cDataCnt, "#,###") & " / " & Format(CXHZ0340_PrtCnt, "#,###")
                End With
            Next
    ...
    ' 印刷終了
    Call CisPrtCXHZ0340.PrintEndDoc
