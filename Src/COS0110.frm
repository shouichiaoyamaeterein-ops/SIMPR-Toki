...
Private Function Proc_Start() As Boolean
    ...
    lb_msg = "【 売上照合処理中 】しばらくお待ち下さい": DoEvents
...
Proc_Start_ED:
    Call CisFun.LogPut("【 売上差異照合 正常終了 】")
...
Proc_Start_Er:
    ...
    Exit Function
Proc_Start_Err:
    CisFun.ErrorBox "売上照合処理"
    Call CisFun.LogPut("【 売上差異照合 異常終了 】")
    End
End Function
'/////////////////////////////////////////////////////
'+---------------------------------------------------+
...
Private Function SyogoProc(ProcType As Integer, sTorcd As String) As Boolean
    ...
    With CisDB
        ...
        .ParaNo = 6:    .ParaIO = OutPut用     ' 自社売上入力件数
    ...
    With CisFun
        Call .LogPut("売上差異照合 処理結果")
       gStr = "  得意先=" & sTorcd & ",買掛金=" & mInCnt(1) & ",売上=" & mInCnt(2)
       If ProcType <> 0 Then
...
SyogoProc_ER:
    Select Case er_No
        Case 3: gStr = "売上明細テーブル 再処理用 初期化 エラー"
        Case 4: gStr = "売上明細テーブル 未照合 初期化 エラー"
        Case 5: gStr = "TEXT買掛金テーブル 再処理用 初期化 エラー"
        Case 6: gStr = "TEXT買掛金テーブル 処理対象データ更新 エラー"
        Case 7: gStr = "売上差異明細テーブル削除 エラー"
        Case 8: gStr = "売上明細テーブル照合項目更新 エラー"
        Case 9: gStr = "TEXT買掛金テーブル照合項目更新 エラー"
        Case 10: gStr = "売上明細テーブル照合項目更新 エラー"
        Case 11: gStr = "TEXT買掛金テーブル照合項目更新 エラー"
        Case 20: gStr = "売上照合ワーク作成 エラー"
        Case 21: gStr = "売上照合ワーク金額再計算 エラー"
        ...
        Case 81: gStr = "売上照合ワーク 照合更新 エラー"
        Case 82, 85: gStr = "売上明細テーブル 照合更新 エラー"
