...
Begin VB.Form CXM2245 
   BorderStyle     =   1  '固定(実線)
   Caption         =   "得意先スクラップ単価 印刷"
   ClientHeight    =   2625
   ClientLeft      =   6270
   ClientTop       =   5850
   ClientWidth     =   5265
...
Private Sub ReturnPress()
    ...
    'CXM2240_PrtCnt = CisDB.RecordCount
    CXM2240_Kara = False
    Set CisPrtCXM2240 = New CISFormPrint
    
'   出力先
    lb_msg.Caption = "【 得意先スクラップ単価 印刷中 】"
    DoEvents
    With CisPrtCXM2240
         Set .iPrtForm = CXM2240L
         .dpMSG = "得意先スクラップ単価　印刷中"
