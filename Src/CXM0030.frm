...
Begin VB.Form CXM0030 
   ...
   Begin VB.PictureBox PNL_Test 
      ...
      Begin Cis3D_v60.CIS3D CIS3D23 
         ...
         cAlingnment     =   6
         cPositionY      =   30
         Begin Cis3D_v60.CIS3D iH1_CPMsg 
            Height          =   345
            Left            =   90
            Top             =   120
            Width           =   3705
   ...
   Begin VB.PictureBox B3_Area1 
      ...
      Begin Cis3D_v60.CIS3D Back_HachuPHA 
         ...
         Begin Cis3D_v60.CIS3D CIS3D13 
            ...
            End
         End
         Begin Cis3D_v60.CIS3D Back_KoteiKanban 
            Height          =   375
            Left            =   0
            Top             =   480
            Width           =   10440
            ...
            Begin Cis3D_v60.CIS3D Back_KanKB 
               ...
               Begin VB.ComboBox B3Comb_KanKB 
                  BackColor       =   &H00C0E0FF&
                  Height          =   360
                  ItemData        =   "CXM0030.frx":0000
                  Left            =   1605
                  List            =   "CXM0030.frx":0002
   ...
   Begin VB.PictureBox H1_Area1 
      ...
      Begin Cis3D_v60.CIS3D BLB_HINBN 
         ...
         End
      End
      Begin Cis3D_v60.CIS3D LBL_Hinbn 
         Height          =   795
         Left            =   3330
         Top             =   60
         Width           =   3870
      ...
      Begin Cis3D_v60.CIS3D CIS3D17 
         ...
         cAlingnment     =   6
         cPositionY      =   30
         Begin CisText_V60.CisText iH1_HinbnCP 
            Height          =   330
            Left            =   60
            TabIndex        =   126
            Top             =   360
...
'**       ïœ  çX  ì˙    :   2009/12/07  By CIS ìyäÚí√Ver(çHíˆÇ©ÇÒÇŒÇÒèÓïÒí«â¡)
'**       ïœ  çX  ì˙    :   2010/01/25  By CIS ìyäÚí√Ver(ï°é ã@î\í«â¡)
'**       ïœ  çX  ì˙    :   2010/07/16  By CIS Gridîwî‘çÜï\é¶çLÇ∞
'**       ïœ  çX  ì˙    :   2011/11/25  By CIS çHêîåvåvéZèCê≥
'**       ïœ  çX  ì˙    :   2013/09/09  By CIS ÉçÉbÉgêîÉ`ÉFÉbÉNçÌèú
'**       ïœ  çX  ì˙    :   2023/09/19  By CIS é–ì‡îwî‘çÜÅAé‘å^ÅAçÄñ⁄à⁄ìÆ(âÊñ ÇÃÇ›ïœçXÅj
'**
'**********************************************************'
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/02/04 INSERT END
    Dim CisComboKanKB   As CisCombo     '2009/12/07
...
'    Dim SAVE_Select     As String
    ...
    Const DebugFlg      As Boolean = True       ' debug
'-------------------------------------------------------------------------------' 2009.10.16 add end
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2009/12/07 INSERT START
    ' ê∂éYéÌï ÅFÇ©ÇÒÇŒÇÒãÊï™
    Set CisComboKanKB = New CisCombo
    With CisComboKanKB
        Set .Connect = CisDB
        Set .CombObj = B3Comb_KanKB
        .Control = "ñºèÃÉ}ÉXÉ^"
        .ComboName = "ê∂éYéÌï Ç©ÇÒÇŒÇÒãÊï™"
        .IniPath = gIniExe
        .SetSpace = 50
        .Ess = False
        .ComboInit
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/02/04 INSERT START
           ...
           Case vbKeyF5:       If PB_KTN.Visible Then Call PB_KTN_Click    'Åyçwì¸íPâøÅz
                               If PB_CPY.Visible Then Call PB_CPY_Click    'Åyï°é Åz            ' 2010.01.25 add
...
Private Sub SyoriName(SYKB As String)
   ...
   Select Case SyoriKB
     Case "ADD"
          ...
          PB_CPY.Left = PB_ADD.Left         ' 2010.01.25 add
          PB_CPY.Visible = True             ' 2010.01.25 add
          LBL_Hinbn.Visible = True          ' 2010.01.25 add
          BLB_HINBN.Caption = "ïi  î‘"      ' 2010.01.25 add
     Case "MNT"
          SyoriNM = "èCê≥"
          K_Sykbnm.ForeColor = &HFF0000  '(ê¬êF)
          PB_CPY.Left = PB_MNT.Left         ' 2010.01.25 add
          PB_CPY.Visible = True             ' 2010.01.25 add
          LBL_Hinbn.Visible = True          ' 2010.01.25 add
          BLB_HINBN.Caption = "ïi  î‘"      ' 2010.01.25 add
     Case "DEL"
          ...
          W_Color = &HFF&
          PB_CPY.Left = PB_DEL.Left         ' 2010.01.25 add
          PB_CPY.Visible = True             ' 2010.01.25 add
          LBL_Hinbn.Visible = True          ' 2010.01.25 add
          BLB_HINBN.Caption = "ïi  î‘"      ' 2010.01.25 add
     Case "LOK"
...
'-------------------------------------------------------' 2010.01.25 add start
    Case "CPY"
        SyoriNM = "ï°é "
        K_Sykbnm.ForeColor = PB_CPY.BtnForeColor
        PB_CPY.Visible = False
        PB_ADD.Visible = True
        PB_MNT.Visible = True
        PB_DEL.Visible = True
        LBL_Hinbn.Visible = False
        BLB_HINBN.Caption = "ï°  é   å≥  ïi  î‘"
'-------------------------------------------------------' 2010.01.25 add end
     Case Else
          SyoriNM = ""
   End Select
...
'
    ...
    PB_CPY.Visible = H1Mode     ' 2010.01.25 add
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/02/04 INSERT END
           ...
           Call CisComboKanKB.ComboSet                  '2009/12/07
...
'*--------------------------------------------------<< 2007/12/14 Insert End >>
    ...
    If CisFun.Val2(iB3_LSu) <> 0 Then
       If CisFun.Val2(iB3_Syuyo1) <> 0 Then
'          If CisFun.Val2(iB3_LSu) Mod CisFun.Val2(iB3_Syuyo1) <> 0 Then                        '2013/09/09 Del
'             With CisFun
'                .MB_Lines = 4
...
'          End If
    ...
    If CisFun.Val2(iB3_LSu2) <> 0 Then
       If CisFun.Val2(iB3_Syuyo2) <> 0 Then
'          If CisFun.Val2(iB3_LSu2) Mod CisFun.Val2(iB3_Syuyo2) <> 0 Then                       '2013/09/09 Del
'             With CisFun
'                .MB_Lines = 4
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/02/04 INSERT END
               ...
               If HTM.ê∂éYéÌï  = 0 Then
                  CisComboKanKB.CodeGet
                  HTM.Ç©ÇÒÇŒÇÒãÊï™ = CisFun.Val2(CisComboKanKB.Code)
                  If HTM.Ç©ÇÒÇŒÇÒãÊï™ = 1 Then
                     If CisFun.Val2(iB3_KKCycle1) <> 0 Or CisFun.Val2(iB3_KKCycle2) <> 0 Or _
                        CisFun.Val2(iB3_KKCycle3) <> 0 Then
                        HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã = Format(iB3_KKCycle1, "0") & _
                                      Format(iB3_KKCycle2, "00") & _
                                      Format(iB3_KKCycle3, "00")
                     Else
                        HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã = ""
                     End If
                     HTM.Ç©ÇÒÇŒÇÒãÊï™ÉçÉbÉg = 0
                  End If
                  If HTM.Ç©ÇÒÇŒÇÒãÊï™ = 2 Then
                     HTM.Ç©ÇÒÇŒÇÒãÊï™ÉçÉbÉg = CisFun.Val2(iB3_KanLot)
                     HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã = ""
                  End If
                  If HTM.Ç©ÇÒÇŒÇÒãÊï™ = 0 Then
                     HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã = "": HTM.Ç©ÇÒÇŒÇÒãÊï™ÉçÉbÉg = 0
                  End If
                  HTM.ê∂éYãÊï™ÉçÉbÉg = 0
               Else
                  HTM.Ç©ÇÒÇŒÇÒãÊï™ = 0
                  HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã = "": HTM.Ç©ÇÒÇŒÇÒãÊï™ÉçÉbÉg = 0
                  HTM.ê∂éYãÊï™ÉçÉbÉg = CisFun.Val2(iB3_KanLot)
               End If
               '====================== *** 2009/12/07 End
...
'-------------------------------------------------------------------------------------------' 2010.01.25 add start
Private Function DBCopy() As Boolean
    Dim wStr    As String
    Const SLPTM As Single = 1       ' debug
    ...
    If Trim(iH1_Hinbn) = "" Then
        With CisFun
            .MB_Lines = 4
            .MB_MSG(2) = "    ï°é å≥ïiî‘Çì¸óÕÇµÇƒâ∫Ç≥Ç¢            "
            .MB_Title = ""
            .MB_Button = Error
            .MBOX
        End With
    ...
    If Not DBInput("INV") Then
        With CisFun
            .MB_Lines = 4
            .MB_MSG(2) = "    ï°é å≥ïiî‘É}ÉXÉ^ñ¢ìoò^Å@Å@            "
            .MB_Title = ""
            .MB_Button = Error
            .MBOX
        End With
    ...
    '-- ï°é êÊïiî‘É`ÉFÉbÉN
    If Trim(iH1_HinbnCP) = "" Then
        With CisFun
            .MB_Lines = 4
            .MB_MSG(2) = "    ï°é êÊïiî‘Çì¸óÕÇµÇƒâ∫Ç≥Ç¢            "
            .MB_Title = ""
            .MB_Button = Error
            .MBOX
        End With
       iH1_HinbnCP.SetFocus
       Exit Function
    End If
    gSL_Select = " SELECT * "
    gSL_Select = gSL_Select & " FROM ïiî‘É}ÉXÉ^ "
    gSL_Select = gSL_Select & " WHERE ïiî‘ = '" & RTrim(iH1_HinbnCP) & "'"
    If HNMRead(gSL_Select) Then
        With CisFun
            .MB_Lines = 4
            .MB_MSG(2) = "    ï°é êÊïiî‘ÇÕä˘Ç…ìoò^Ç≥ÇÍÇƒÇ¢Ç‹Ç∑    Å@"
            .MB_Title = ""
            .MB_Button = Error
            .MBOX
        End With
    ...
    '-- ïiî‘É}ÉXÉ^Å@ï°é 
    gSL_Select = "SELECT * FROM ïiî‘É}ÉXÉ^ WHERE ïiî‘ = '" & Trim(iH1_Hinbn) & "'"
    HNMRead (gSL_Select)
    PNL_Test.Visible = DebugFlg: If DebugFlg Then iH1_CPMsg.Caption = "ïiî‘É}ÉXÉ^Å@ï°é íÜ": Call xwait(SLPTM)           ' debug
    With HNM
        .ïiî‘ = Trim(iH1_HinbnCP)
        wStr = .ïiî‘ï“èW
        .ï\é¶ïiî‘ = EditHinbn(iH1_HinbnCP, wStr)
        .çÏê¨é“ = gTanto
    End With
    Call HNMInsert
    
    '-- ïiî‘éÊà¯êÊÉ}ÉXÉ^Å@ï°é 
    gSL_Select = "SELECT * FROM ïiî‘éÊà¯êÊÉ}ÉXÉ^ WHERE ïiî‘ = '" & Trim(iH1_Hinbn) & "'"
    If HTMRead(gSL_Select) Then
        PNL_Test.Visible = DebugFlg: If DebugFlg Then iH1_CPMsg.Caption = "ïiî‘éÊà¯êÊÉ}ÉXÉ^Å@ï°é íÜ": Call xwait(SLPTM) ' debug
        Do While HTM_RDSTS
            With HTM
                .ïiî‘ = Trim(iH1_HinbnCP)
                .çÏê¨é“ = gTanto
    ...
    '-- ïiî‘çHèáÉ}ÉXÉ^Å@ï°é 
    gSL_Select = "SELECT * FROM ïiî‘çHèáÉ}ÉXÉ^ WHERE ïiî‘ = '" & Trim(iH1_Hinbn) & "'"
    If HKTRead(gSL_Select) Then
        PNL_Test.Visible = DebugFlg: If DebugFlg Then iH1_CPMsg.Caption = "ïiî‘çHèáÉ}ÉXÉ^Å@ï°é íÜ": Call xwait(SLPTM)   ' debug
        Do While HKT_RDSTS
            With HKT
                .ïiî‘ = Trim(iH1_HinbnCP)
                .çÏê¨é“ = gTanto
        ...
        Loop
    End If
    PNL_Test.Visible = True: If DebugFlg Then iH1_CPMsg.Caption = "ï°é èIóπ": Call xwait(SLPTM): _
                             iH1_CPMsg.Caption = "": PNL_Test.Visible = False: DoEvents                                 ' debug
    
    With CisFun
        .MB_Lines = 4
        .MB_MSG(2) = "    ï°é ÇµÇ‹ÇµÇΩ    Å@Å@        "
        .MB_Title = ""
        .MB_Button = OK
        .MBOX
    End With

    iH1_Hinbn = iH1_HinbnCP     ' ï°é ÇµÇΩïiî‘Ç≈èCê≥Ç…ì¸ÇÈ
    SyoriKB = "MNT"
    Call SyoriName(SyoriKB)
...
DBCopy_Err:
    ...
    With CisDB
        .DBTran (TransBegin) ' ƒ◊›ªﬁ∏ºÆ›äJén
    ' ( ÉGÉâÅ[Ç…ÇÊÇÈçÌèúèàóù )
        ' ïiî‘É}ÉXÉ^
        .SQL = "DELETE FROM ïiî‘É}ÉXÉ^ "
        .SQL = .SQL & " WHERE ïiî‘ = '" & RTrim(iH1_HinbnCP) & "'"
        .DBExec
        ' ïiî‘éÊà¯êÊÉ}ÉXÉ^
        .SQL = "DELETE FROM ïiî‘éÊà¯êÊÉ}ÉXÉ^ "
        .SQL = .SQL & " WHERE ïiî‘ = '" & RTrim(iH1_HinbnCP) & "'"
    ...
    If DebugFlg Then iH1_CPMsg.Caption = "": PNL_Test.Visible = False: DoEvents                                         ' debug
    
    With CisFun
        .MB_Lines = 4
        .MB_MSG(2) = "    ï°é íÜÇ…ÉGÉâÅ[Ç™î≠ê∂ÇµÇ‹ÇµÇΩ         "
        .MB_Title = ""
        .MB_Button = Error
        .MBOX
    End With
...
DBCopy_ED:
End Function
Private Sub xwait(sec As Single)        ' debugóp
    Dim ima As Single, wt As Single
    ima = Timer    'äJénÇÃéûä‘
    Do
        wt = Timer    'ç°ÇÃéûä‘
        DoEvents       'êßå‰ÇOSÇ…ìnÇ∑
...
'        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 0, 3, "îwî‘çÜ")                       '2010/07/16
        Call .FixedSet(íÜíÜ, ç∂íÜ, Ç†ÇË, 8, 3, "îwî‘çÜ")                      '2010/07/16
...
'        gSL_Select = "Select HT.*,TU.ójì˙î≠íç from ïiî‘éÊà¯êÊÉ}ÉXÉ^ HT"
        gSL_Select = "Select HT.*,ISNULL(TU.ójì˙î≠íç,'') ójì˙î≠íç from ïiî‘éÊà¯êÊÉ}ÉXÉ^ HT"         '2009/12/07
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/02/04 INSERT END
           ...
           '================================ *** 2009/12/07 Start
            'ê∂éYéÌï 
            B3Op_SKbn(HTM.ê∂éYéÌï ).Value = True
            Call B3Op_SKbn_Click(CInt(HTM.ê∂éYéÌï ))
            'Ç©ÇÒÇŒÇÒãÊï™(ê∂éYéÌï =0)
            If B3Op_SKbn(0) Then
               CisComboKanKB.Code = HTM.Ç©ÇÒÇŒÇÒãÊï™
               CisComboKanKB.TextGet
               Call B3Comb_Kankb_Click
               If HTM.Ç©ÇÒÇŒÇÒãÊï™ = 1 Then
                  iB3_KKCycle1 = Mid(HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã, 1, 1)
                  iB3_KKCycle2 = Mid(HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã, 2, 2)
                  iB3_KKCycle3 = Mid(HTM.Ç©ÇÒÇŒÇÒãÊï™ÉTÉCÉNÉã, 4, 2)
                  iB3_KanLot = ""
               End If
               If HTM.Ç©ÇÒÇŒÇÒãÊï™ = 2 Then
                  iB3_KanLot = Format(HTM.Ç©ÇÒÇŒÇÒãÊï™ÉçÉbÉg, "###,###")
            ...
            'ê∂éYãÊï™ÉçÉbÉg
            If B3Op_SKbn(1) Then
               iB3_KanLot = Format(HTM.ê∂éYãÊï™ÉçÉbÉg, "###,###")
               iB3_KKCycle1 = "": iB3_KKCycle2 = "": iB3_KKCycle3 = ""
            End If
           '================================ *** 2009/12/07 End
...
'        Kosu_Goukei = HKT.äÓèÄçHêî1                                '2011/11/25
        Kosu_Goukei = Kosu_Goukei + HKT.äÓèÄçHêî1                   '2011/11/25
...
' ê∂éYéÌï ÅFÇ©ÇÒÇŒÇÒãÊï™ÅEÅEÅEïiî‘çHèá
    Call ItemsClearSYMCreate
    With SYMCreate
        .ãÊï™ñºèÃ = "ê∂éYéÌï Ç©ÇÒÇŒÇÒãÊï™"
        .ãÊï™åÖêî = 1
        .íl = "1"
        .êßå‰ãÊï™ = "X"
        .ílñºèÃ = "í èÌ"
        .çÏê¨é“ = gTanto
        .åüçıñº = "Ç© ÇÒ ÇŒ ÇÒ ãÊ ï™ åü çı"
        .ÉRÅ[Éhñº = "Ç©ÇÒãÊ"
        .ñºèÃñº = "Ç© ÇÒ ÇŒ ÇÒ ãÊ ï™ ñº"
        If Not SYMInitCreate(True) Then
            .íl = "2"
            .ílñºèÃ = "éOäp"
            Call SYMInitCreate
...
' ä«óùèÍèäÅEÅEÅEïiî‘çHèá
    ...
    With SYMCreate
        ...
        .ílñºèÃ = "ÇªÇÃëº"
        .çÏê¨é“ = gTanto
        .åüçıñº = "ä« óù èÍ èä åü çı"
        .ÉRÅ[Éhñº = "ä«óùèÍ"
        .ñºèÃñº = "ä« óù èÍ èä ñº"
        If Not SYMInitCreate(True) Then
        End If
    End With
' ä«óùèÍèäÉÜÅ[ÉUÅ[ÅEÅEÅEïiî‘çHèá
    Call ItemsClearSYMCreate
    With SYMCreate
        .ãÊï™ñºèÃ = "ä«óùèÍèäÉÜÅ[ÉUÅ["
        .ãÊï™åÖêî = 2
        .íl = "99"
        .ílñºèÃ = "ÇªÇÃëº"
        .çÏê¨é“ = gTanto
        .åüçıñº = "ä«óùèÍèä’∞ªﬁ∞åüçı"
        .ÉRÅ[Éhñº = "ä«óùÉÜ"
        .ñºèÃñº = "ä«óùèÍèä’∞ªﬁ∞ñº"
        If Not SYMInitCreate(True) Then
        End If
    End With
' ïWèÄíiéÊÅEÅEÅEïiî‘çHèá
    Call ItemsClearSYMCreate
    With SYMCreate
        .ãÊï™ñºèÃ = "ïWèÄíiéÊ"
        .ãÊï™åÖêî = 1
