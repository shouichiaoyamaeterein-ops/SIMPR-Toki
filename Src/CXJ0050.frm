...
Begin VB.Form CXJ0050 
   BackColor       =   &H00808000&
   BorderStyle     =   1  'å≈íË(é¿ê¸)
   Caption         =   "éÛíçÉ`ÉPÉbÉgì¸óÕ"
   ClientHeight    =   11235
   ClientLeft      =   1800
   ClientTop       =   1515
   ClientWidth     =   15360
   ...
   Begin Cis3D_v60.CIS3D PGName 
      ...
      BackColor       =   14737632
      ForeColor       =   0
      Caption         =   "Åy éÛíçÉ`ÉPÉbÉgì¸óÕ  Åz"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ÇlÇr ÉSÉVÉbÉN"
         Size            =   14.25
         Charset         =   128
...
'
    ...
    If SyoriKb = "RED" And ProcHB = "B1" Then
       PB_CAN.Visible = True
    End If
    
    PB_ADD.Visible = B2Mode
    PB_RED.Visible = B1Mode
...
'
    If Mid(QT10QSR_ReadData, 1, 1) = "A" Then
    Else
        With CisFun
             .MB_Lines = 5
             .MB_MSG(2) = "  ëŒè€äOì`ï[Ç≈Ç∑      "
             .MB_Title = ""
             .MB_Button = Error
             .MBOX
        End With
...
Private Function ChekData(ReadType As Integer, OutType As Integer, ChekFlg As Integer) As Boolean
    ...
    With CisDB
        ...
        .ParaNo = 4: .ParaIO = Inputóp      ' ÉwÉbÉhì‡óe
        .ParaNo = 5: .ParaIO = InOutóp      ' ì`ï[ÇÃñæç◊ïî(<7ñæç◊ï™>)
        .ParaNo = 6: .ParaIO = OutPutóp     ' É`ÉFÉbÉNÉGÉâÅ[NO
        .ParaNo = 7: .ParaIO = OutPutóp     ' É`ÉFÉbÉNÉGÉâÅ[çsNO
        ...
        .ParaNo = 4: .ParaValue = wcc_Head
        .ParaNo = 5: .ParaValue = wcc_Body

        If Not .DBStored Then End
        ' ÉGÉâÅ[î‘çÜ
        .ParaNo = 6: wErNo = CisFun.Val2(.ParaValue)
        ' ÉGÉâÅ[çsNo
        .ParaNo = 7: wErGyo = CisFun.Val2(.ParaValue)
...
'--              99: ÉfÅ[É^çXêVÉGÉâÅ[
    ...
    With CisFun
        ...
        Select Case wErNo
            ...
            Case 15
                    .MB_MSG(2) = "Åy  " & StrConv(wErGyo, vbWide) & " çsñ⁄  Åz"
                    .MB_MSG(4) = "       ïiî‘éÊà¯êÊÉ}ÉXÉ^ñ¢ìoò^     "
