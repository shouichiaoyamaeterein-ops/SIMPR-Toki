...
Begin VB.Form CXH0531 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Height          =   5500
         Left            =   90
         OleObjectBlob   =   "CXH0531.frx":0000
         TabIndex        =   11
         Top             =   90
         Width           =   7070
      End
...
'        Sl_Where = Sl_Where & ")"
'    End If
    Sl_Where = Sl_Where & " and  jkt.実績区分 = 3"
...
'*      ボディ内容セット
'****************************
Private Function BodySet_old() As Boolean
    BodySet = False
...
Print #fileNo, gSL_Select & Chr(&HD) & Chr(&HD) 'ファイルへ書き込む
