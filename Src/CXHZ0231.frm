...
Begin VB.Form CXHZ0231 
   BackColor       =   &H00808000&
   BorderStyle     =   1  '固定(実線)
   Caption         =   "材料入荷画面入力データ参照"
   ClientHeight    =   7740
   ClientLeft      =   1785
   ClientTop       =   2490
   ClientWidth     =   9555
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CXHZ0231.frx":0000
         Height          =   5550
         Left            =   90
         OleObjectBlob   =   "CXHZ0231.frx":0015
         TabIndex        =   2
         Top             =   60
         Width           =   9075
      End
...
Private Function BodySet() As Boolean
    ...
    gSL_Select = gSL_Select & " FROM 材料入荷画面入力ワーク HG "
