...
'**********************************************************'
    ...
    Dim iRdCnt          As Long         ' 2019/07/18 ADD：品番件数カウント用
    Dim wHinbn()        As String       ' 2019/07/18 ADD：品番情報
    Dim wRdAll()        As Variant      ' 2019/07/18 ADD：構成問合せワーク：全体
    Dim wRdHbn()        As String       ' 2019/07/18 ADD：構成問合せワーク：品番
'+----------------------------------------------------------+
'+      フォーム    《    Ｌｏａｄイベント    》              +
'+----------------------------------------------------------+
...
'        wSQL = wSQL & vbCrLf & " GROUP BY HM.品番"
...
'    Next
'
'    ReDim wRdAll(14, iRdCnt)
'    ReDim wRdHbn(4, iRdCnt)
'
'
'
'
'    ReDim Preserve wRdAll(14, 20)       ' 2019/07/18 ADD
'    ReDim Preserve wRdHbn(4, 5)         ' 2019/07/18 ADD
'===========================================================================================' 2019/07/18 ADD END
