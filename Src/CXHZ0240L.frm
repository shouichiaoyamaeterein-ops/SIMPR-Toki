...
'*---------------------------------*
    ...
    Call CisPrtCXHZ0240.ClrLstFld("B1")
...
'*---------------------------------*
    Do Until Not ZNG_RDSTS
        If Key_Torcd <> ZNG.édì¸êÊ Or Key_KTorcd <> ZNG.å_ñÒêÊ Or _
            CisPrtCXHZ0240.cLine >= CisPrtCXHZ0240.iLineMax Then
            If RTrim(Key_Torcd) <> "" Then
                B1_K_LINE1.Visible = True
                Call CisPrtCXHZ0240.PrintFld("B1*")
                CisPrtCXHZ0240.cLine = CisPrtCXHZ0240.cLine + 1
                Call CisPrtCXHZ0240.ClrLstFld("B1")
            End If
            Call HeadWrite(0)
        End If
...
'                GTMaisu = GTMaisu + .ñáêî
    ...
    'BODYïîàÛç¸
        ...
        With CisPrtCXHZ0240
            .cDataCnt = .cDataCnt + 1
            .dpCountDisp Format(.cDataCnt, "#,###") & " / " & Format(CXHZ0240_PrtCnt, "#,###")
        End With
...
'ç≈èIï≈Å@ñáêîåvàÛç¸
    ...
    ' àÛç¸èIóπ
    Call CisPrtCXHZ0240.PrintEndDoc
