...
'*---------------------------------*
    MaxGyo = 3: GGyo = 0
    Call CisPrtCXH0360.ClrLstFld("B1")
    Call HeadWrite(0)
...
'*---------------------------------*
    Do Until Not HCT_RDSTS
        ...
        'QR
            ...
            B1_QRmaker1.Refresh
        'BODY部印刷
            Call CisPrtCXH0360.PrintFld("B1*")
            CisPrtCXH0360.cLine = CisPrtCXH0360.cLine + 23
            Call CisPrtCXH0360.ClrLstFld("B1")
            ...
            With CisPrtCXH0360
                .cDataCnt = .cDataCnt + 1
                .dpCountDisp Format(.cDataCnt, "#,###") & " / " & Format(CXH0360_PrtCnt, "#,###")
            End With
    ...
    ' 印刷終了
    Call CisPrtCXH0360.PrintEndDoc
...
'    Mid(mQRData, 101, 3) = "001"                        '現枚数
'    Mid(mQRData, 104, 3) = "001"                        '総枚数
...
'    Mid(mQRData, 139, 1) = Format(HCT.発注区分, "0")    '発注区分
    ...
    Mid(mQRData, 104, 3) = "001"                        '現枚数
    Mid(mQRData, 107, 3) = "001"                        '総枚数
    CisFun.DateE_AfVal = mPrtDate
    CisFun.DateEditUn
