...
Object = "{BA5D7819-2B67-11D4-806A-00000EA57F9E}#3.0#0"; "CisYMD_6.0.ocx"
Begin VB.Form COK0520 
   BackColor       =   &H00808000&
   BorderStyle     =   1  'å≈íË(é¿ê¸)
   Caption         =   "îÉä|èÛãµä«óù"
   ClientHeight    =   11010
   ClientLeft      =   1140
   ClientTop       =   1140
   ClientWidth     =   15375
   ...
   Begin Cis3D_v60.CIS3D UC_3D31 
      ...
      BackColor       =   14737632
      ForeColor       =   0
      Caption         =   "Å@Å@Å@Åy îÉä|èÛãµä«óù Åz"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ÇlÇr ÉSÉVÉbÉN"
         Size            =   14.25
         Charset         =   128
...
'**********************************************************'
'**
'**       ÉtÉHÅ[ÉÄñº    :  îÉä|é¿ê—ñ‚çáÇπ
'**       ÉtÉHÅ[ÉÄID    :  CXU0520
'**       èàóùäTóv      :
'**
'**       çÏ  ê¨  ì˙    :  2008/06/18 By CIS
'**       ïœ  çX  ì˙    :  2009/02/13 By CIS çﬁóøîÉä|Ç‡çáåvÇµÇƒï\é¶
'**
'**********************************************************'
...
Private Sub PB_PRT_Click()
    COK0520_YM = CisFun.Mid2(iH1_YMD, 1, 6)
    COK0520_MD1 = GTitleDay(0)
    COK0520_MD2 = GTitleDay(1)
    COK0520_MD3 = GTitleDay(2)
    COK0520_MD4 = GTitleDay(3)
    COK0520_MD5 = GTitleDay(4)
    COK0520_MD6 = GTitleDay(5)
    
    COK0525.Show vbModal
    Unload COK0525
    Set COK0525 = Nothing
...
' ∏ﬁÿØƒﬁçsçƒæØƒ & óÒà íuéÊìæ
    ...
    Do Until Not KNV_RDSTS
        With VSGrid1
            ' å_ñÒêÊ
            .TextMatrix(ID, GridCol(1)) = RTrim(KNV.ï“èWå_ñÒêÊ)
            ' ó\ë™ã‡äz
            .TextMatrix(ID, GridCol(2)) = Format(KNV.ó\ë™ã‡äz, "#,###")
            ' é¿ê—ã‡äz
            .TextMatrix(ID, GridCol(3)) = Format(KNV.é¿ê—ã‡äz, "#,###")
            If CisFun.Val2(KNV.êiíª) <> 0 Then
               .TextMatrix(ID, GridCol(4)) = Format(KNV.êiíª, "#,##0.0;;#") & "%"
            End If
            .TextMatrix(ID, GridCol(5)) = Format(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2))), "#,###")
            .TextMatrix(ID, GridCol(6)) = Format(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2))), "#,###")
            .TextMatrix(ID, GridCol(7)) = Format(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2))), "#,###")
            .TextMatrix(ID, GridCol(8)) = Format(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2))), "#,###")
            .TextMatrix(ID, GridCol(9)) = Format(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2))), "#,###")
            .TextMatrix(ID, GridCol(10)) = Format(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2))), "#,###")
            .TextMatrix(ID, GridCol(11)) = Format(KNV.ì˙ìñÇËêî, "#,###")
            ID = ID + 1
        End With
        Call KNVReadNext
    Loop
...
' ∏ﬁÿØƒﬁçsçƒæØƒ & óÒà íuéÊìæ
    ...
    Do Until Not KNV_RDSTS
        With VsGrid2
            ' çsê›íË
            ID = CisFun.Val2(KNV.é©é–çHãÊ) + 1
            ' ó\ë™ã‡äz
            .TextMatrix(ID, 1) = CisFun.RSetFld(KNV.ó\ë™ã‡äz, 13, "#,###")
            GKeiYs = GKeiYs + KNV.ó\ë™ã‡äz
            ' é¿ê—ã‡äz
            .TextMatrix(ID, 2) = CisFun.RSetFld(KNV.é¿ê—ã‡äz, 13, "#,###")
            GKeiJs = GKeiJs + KNV.é¿ê—ã‡äz
            If CisFun.Val2(KNV.êiíª) <> 0 Then
               .TextMatrix(ID, 3) = CisFun.RSetFld(KNV.êiíª, 5, "#,##0.0;;#") & "%"
            End If
            .TextMatrix(ID, 4) = CisFun.RSetFld(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2))), 11, "#,###")
            GKeiMD1 = GKeiMD1 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)))
            .TextMatrix(ID, 5) = CisFun.RSetFld(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2))), 11, "#,###")
            'GKeiMD2 = GKeiMD2 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)))
            GKeiMD2 = GKeiMD2 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)))     '2009/02/10
            .TextMatrix(ID, 6) = CisFun.RSetFld(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2))), 11, "#,###")
            'GKeiMD3 = GKeiMD3 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)))
            GKeiMD3 = GKeiMD3 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)))     '2009/02/10
            .TextMatrix(ID, 7) = CisFun.RSetFld(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2))), 11, "#,###")
            'GKeiMD4 = GKeiMD4 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)))
            GKeiMD4 = GKeiMD4 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)))     '2009/02/10
            .TextMatrix(ID, 8) = CisFun.RSetFld(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2))), 11, "#,###")
            'GKeiMD5 = GKeiMD5 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)))
            GKeiMD5 = GKeiMD5 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)))     '2009/02/10
            .TextMatrix(ID, 9) = CisFun.RSetFld(KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2))), 11, "#,###")
            'GKeiMD6 = GKeiMD6 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)))
            GKeiMD6 = GKeiMD6 + KNV.é¿ê—ã‡äzT(CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)))     '2009/02/10
            .TextMatrix(ID, 10) = CisFun.RSetFld(KNV.ì˙ìñÇËêî, 11, "#,###")
            GKeiDA = GKeiDA + KNV.ì˙ìñÇËêî
        End With
        Call KNVReadNext
    Loop
...
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/06/12 INSERT END
    ...
    End If
    gSL_Select = gSL_Select & "   FROM îÉä|ì¸â◊èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    ...
    gSL_Select = gSL_Select & "   FROM îÉä|ì‡é¶èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    gSL_Select = gSL_Select & wWhereN & vbCrLf
    gSL_Select = gSL_Select & "  GROUP BY å_ñÒêÊ, å_ñÒêÊñº, ï“èWå_ñÒêÊ"
    
'Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢ 2009/02/13 INSERT START
    gSL_Select = gSL_Select & " UNION" & vbCrLf
    ...
    Else
       gSL_Select = gSL_Select & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & "" & vbCrLf
    End If
    gSL_Select = gSL_Select & "   FROM çﬁóøîÉä|ì¸â◊èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    gSL_Select = gSL_Select & wWhereS & vbCrLf
    gSL_Select = gSL_Select & "  GROUP BY å_ñÒêÊ, å_ñÒêÊñº, ï“èWå_ñÒêÊ" & vbCrLf
    ...
    gSL_Select = gSL_Select & " SELECT å_ñÒêÊ, å_ñÒêÊñº, ï“èWå_ñÒêÊ, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    gSL_Select = gSL_Select & "        0,0,0,0,0,0" & vbCrLf
    gSL_Select = gSL_Select & "   FROM çﬁóøîÉä|ì‡é¶èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    gSL_Select = gSL_Select & wWhereN & vbCrLf
    gSL_Select = gSL_Select & "  GROUP BY å_ñÒêÊ, å_ñÒêÊñº, ï“èWå_ñÒêÊ"
'Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢ 2009/02/13 INSERT END
    gSL_Select = gSL_Select & " ) SY" & vbCrLf
    ...
    If Not KNVRead(gSL_Select) Then Exit Function
    
    COK0520_SQL1 = gSL_Select
...
'Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢ 2009/04/01 INSERT END
    ...
    gSL_Select = gSL_Select & "             ON SY.ãÊï™ñºèÃ = 'é©é–çHãÊ'"
    gSL_Select = gSL_Select & "            AND SY.íl = é©é–çHãÊ"
    ...
    gSL_Select = gSL_Select & "            AND SY.ãÊï™É^ÉCÉv = ''"
    gSL_Select = gSL_Select & wWhereN & vbCrLf
    gSL_Select = gSL_Select & "  GROUP BY é©é–çHãÊ, SY.ílñºèÃ"
'Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£Å•Å£ 2009/02/13 INSERT START
    gSL_Select = gSL_Select & " UNION" & vbCrLf
    gSL_Select = gSL_Select & " SELECT é©é–çHãÊ, ISNULL(SY.ílñºèÃ, '') é©é–çHãÊñº, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    If CisFun.Mid2(GTitleDay(0), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
    ...
    gSL_Select = gSL_Select & " SELECT é©é–çHãÊ, ISNULL(SY.ílñºèÃ, '') é©é–çHãÊñº, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    gSL_Select = gSL_Select & "        0,0,0,0,0,0,CASE WHEN SUM(ó\ë™ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    gSL_Select = gSL_Select & "             CASE WHEN SUM(é¿ê—ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    gSL_Select = gSL_Select & "                  ROUND(SUM(é¿ê—ã‡äz) / SUM(ó\ë™ã‡äz) * 100, 1)" & vbCrLf
    gSL_Select = gSL_Select & "        END  END êiíª," & vbCrLf
    If wKadou = 0 Then
...
'Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢Å§Å¢ 2009/02/12 INSERT START
    COK0520_SQL4 = " SELECT é©é–çHãÊ, é©é–çHãÊñº, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & ") é¿ê—ã‡äz0," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)) & ") é¿ê—ã‡äz1," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)) & ") é¿ê—ã‡äz2," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)) & ") é¿ê—ã‡äz3," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)) & ") é¿ê—ã‡äz4," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & ") é¿ê—ã‡äz5," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        CASE WHEN SUM(ó\ë™ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "             CASE WHEN SUM(é¿ê—ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "                  ROUND(SUM(é¿ê—ã‡äz) / SUM(ó\ë™ã‡äz) * 100, 1)" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        END  END êiíª," & vbCrLf
    If wKadou = 0 Then
       COK0520_SQL4 = COK0520_SQL4 & "        0 ì˙ìñÇËêî"
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COK0520_SQL4 = COK0520_SQL4 & "   FROM ("
    
    COK0520_SQL4 = COK0520_SQL4 & " SELECT é©é–çHãÊ, ISNULL(SY.ílñºèÃ, '') é©é–çHãÊñº, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    If CisFun.Mid2(GTitleDay(0), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
       COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & "," & vbCrLf
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & "," & vbCrLf
    End If
    If CisFun.Mid2(GTitleDay(1), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
       COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)) & "," & vbCrLf
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(1), 4, 2)) & "," & vbCrLf
    End If
    If CisFun.Mid2(GTitleDay(2), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
       COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)) & "," & vbCrLf
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(2), 4, 2)) & "," & vbCrLf
    End If
    If CisFun.Mid2(GTitleDay(3), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
       COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)) & "," & vbCrLf
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(3), 4, 2)) & "," & vbCrLf
    End If
    If CisFun.Mid2(GTitleDay(4), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
       COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)) & "," & vbCrLf
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(4), 4, 2)) & "," & vbCrLf
    End If
    If CisFun.Mid2(GTitleDay(5), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
       COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & "," & vbCrLf
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(5), 4, 2)) & "," & vbCrLf
    End If
    COK0520_SQL4 = COK0520_SQL4 & "        CASE WHEN SUM(ó\ë™ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "             CASE WHEN SUM(é¿ê—ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "                  ROUND(SUM(é¿ê—ã‡äz) / SUM(ó\ë™ã‡äz) * 100, 1)" & vbCrLf
    ...
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COK0520_SQL4 = COK0520_SQL4 & "   FROM îÉä|ì¸â◊èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        LEFT OUTER JOIN ñºèÃÉ}ÉXÉ^ SY"
    COK0520_SQL4 = COK0520_SQL4 & "             ON SY.ãÊï™ñºèÃ = 'é©é–çHãÊ'"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.íl = é©é–çHãÊ"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.ãÊï™É^ÉCÉv = ''"
    COK0520_SQL4 = COK0520_SQL4 & wWhereS & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "  GROUP BY é©é–çHãÊ, SY.ílñºèÃ" & vbCrLf
    
    COK0520_SQL4 = COK0520_SQL4 & " UNION" & vbCrLf
    
    If CisFun.Val2(CisFun.Mid2(iH1_YMD, 7, 2)) < 7 Or CisFun.Val2(CisFun.Mid2(iH1_YMD, 7, 2)) > 25 Then
        COK0520_SQL4 = COK0520_SQL4 & " SELECT é©é–çHãÊ, ISNULL(SY.ílñºèÃ, '') é©é–çHãÊñº, 0 ó\ë™ã‡äz, 0 é¿ê—ã‡äz," & vbCrLf
        If CisFun.Mid2(GTitleDay(0), 1, 2) = CisFun.Mid2(iH1_YMD, 5, 2) Then
           COK0520_SQL4 = COK0520_SQL4 & "        0 é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & "," & vbCrLf
        Else
           COK0520_SQL4 = COK0520_SQL4 & "        SUM(é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & ") é¿ê—ã‡äz" & CisFun.Val2(CisFun.Mid2(GTitleDay(0), 4, 2)) & "," & vbCrLf
        ...
        COK0520_SQL4 = COK0520_SQL4 & "            AND SY.íl = é©é–çHãÊ"
        COK0520_SQL4 = COK0520_SQL4 & "            AND SY.ãÊï™É^ÉCÉv = ''"
        COK0520_SQL4 = COK0520_SQL4 & wWhereSS & vbCrLf
        COK0520_SQL4 = COK0520_SQL4 & "  GROUP BY é©é–çHãÊ, SY.ílñºèÃ" & vbCrLf
    ...
    COK0520_SQL4 = COK0520_SQL4 & " SELECT é©é–çHãÊ, ISNULL(SY.ílñºèÃ, '') é©é–çHãÊñº, SUM(ó\ë™ã‡äz) ó\ë™ã‡äz, SUM(é¿ê—ã‡äz) é¿ê—ã‡äz," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        0,0,0,0,0,0," & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        CASE WHEN SUM(ó\ë™ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "             CASE WHEN SUM(é¿ê—ã‡äz) = 0 THEN 0 ELSE" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "                  ROUND(SUM(é¿ê—ã‡äz) / SUM(ó\ë™ã‡äz) * 100, 1)" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        END  END êiíª," & vbCrLf
    ...
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COK0520_SQL4 = COK0520_SQL4 & "   FROM îÉä|ì‡é¶èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        LEFT OUTER JOIN ñºèÃÉ}ÉXÉ^ SY"
    COK0520_SQL4 = COK0520_SQL4 & "             ON SY.ãÊï™ñºèÃ = 'é©é–çHãÊ'"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.íl = é©é–çHãÊ"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.ãÊï™É^ÉCÉv = ''"
    COK0520_SQL4 = COK0520_SQL4 & wWhereN & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "  GROUP BY é©é–çHãÊ, SY.ílñºèÃ"
    ...
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COK0520_SQL4 = COK0520_SQL4 & "   FROM çﬁóøîÉä|ì¸â◊èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        LEFT OUTER JOIN ñºèÃÉ}ÉXÉ^ SY"
    COK0520_SQL4 = COK0520_SQL4 & "             ON SY.ãÊï™ñºèÃ = 'é©é–çHãÊ'"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.íl = é©é–çHãÊ"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.ãÊï™É^ÉCÉv = ''"
    ...
    Else
       COK0520_SQL4 = COK0520_SQL4 & "        ROUND(SUM(ó\ë™ã‡äz) / " & wKadou & ",1) ì˙ìñÇËêî"
    End If
    COK0520_SQL4 = COK0520_SQL4 & "   FROM çﬁóøîÉä|ì‡é¶èÛãµä«óùÉrÉÖÅ[" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "        LEFT OUTER JOIN ñºèÃÉ}ÉXÉ^ SY"
    COK0520_SQL4 = COK0520_SQL4 & "             ON SY.ãÊï™ñºèÃ = 'é©é–çHãÊ'"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.íl = é©é–çHãÊ"
    COK0520_SQL4 = COK0520_SQL4 & "            AND SY.ãÊï™É^ÉCÉv = ''"
    COK0520_SQL4 = COK0520_SQL4 & wWhereN & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & "  GROUP BY é©é–çHãÊ, SY.ílñºèÃ"
    COK0520_SQL4 = COK0520_SQL4 & "  ) SY" & vbCrLf
    
    COK0520_SQL4 = COK0520_SQL4 & "  GROUP BY é©é–çHãÊ, é©é–çHãÊñº" & vbCrLf
    COK0520_SQL4 = COK0520_SQL4 & " ORDER BY é©é–çHãÊ" & vbCrLf
