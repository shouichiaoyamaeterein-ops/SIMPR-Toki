...
Begin VB.Form CXH0011 
   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin TrueOleDBGrid60.TDBGrid DBGrid1 
         Bindings        =   "CXH0011.frx":0000
         Height          =   5550
         Left            =   90
         OleObjectBlob   =   "CXH0011.frx":0015
         TabIndex        =   2
         Top             =   60
         Width           =   9075
      End
...
Private Function BodySet() As Boolean
    ...
    gSL_Select = gSL_Select & " FROM 発注画面入力ワーク HG "
