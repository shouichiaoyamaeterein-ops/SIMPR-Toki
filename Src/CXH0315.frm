   ...
   Begin VB.PictureBox B1_Area1 
      ...
      Begin Cis3D_v60.CIS3D CIS3D11 
         ...
         Begin vsFlexLib.vsFlexArray vsGrid1 
            ...
            Appearance      =   1
            ConvInfo        =   1418783674
            FormatString    =   "№  |伝種|納 入 日 　-便|仕入先 |   仕  入  先  名   |受入|納 番 |頁|発注区|手配区|SK|品　番  　　            |"
            Rows            =   21
            Cols            =   17
            BackColor       =   12648447
...
Private Sub PB_Prt_Click()
    If ProcHB = "B1" Then
        If Body1Chk Then
            ...
            wPrintKB = 1                ' 帳票区分：0=5 Else 1=105
            Call CXH0310LPrint(wPrintKB)
...
'   ### 再発行最新 ###
        ...
        gSL_Select = gSL_Select & "   and cht.帳票区分 = 5"
...
Public Function DBDelete_CHT(Optional DBNo As Integer) As Boolean
    ...
    With CHT
        ...
        gSL_Select = gSL_Select & "   and 帳票区分 = 105"
    End With
    With CisDB
        .ConnectNo = DBNo
        .SQL = gSL_Select
...
Private Sub HchInfoToGrid1(SetRow As Long)
    With vsGrid1
        ...
        If CisFun.Mid2(HCH.納入番号, 5, 1) <> "0" Then
            .TextMatrix(SetRow, CisVsGrid1.FixedGet(11)) = RTrim(HCH.表示品番(1))
        End If
        '納品書管理NO
