...
Begin VB.Form CKNZ0225 
   ...
   Begin VB.PictureBox H1_Area1 
      ...
      Begin vsFlexLib.vsFlexArray vsGrid1 
         ...
         Appearance      =   1
         ConvInfo        =   1418783674
         FormatString    =   "№ |仕入先 |仕入先名　　　　　　|受入|材  質　　　　　　　　　|背番号|収容器   |収容数  |発行連番|発行|編集前品番|Select|"
         Rows            =   26
         Cols            =   13
         BackColor       =   12648447
...
Private Sub ColorSet(cRow As Long, Optional cColSel As Integer = 0)
    ...
    With vsGrid1
        ...
        With CisDB
            ...
            .SQL = .SQL & " Where かんばん種類 = " & kn_PrtKB
            .SQL = .SQL & " And   材料管理番号 = " & CisFun.Val2(vsGrid1.TextMatrix(cRow, 10))
'-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-* 2008/04/11 UPDATE START
