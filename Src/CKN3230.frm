...
Private Sub PB_Back_Click()
    ...
    gSL_Select = gSL_Select & " And 品目 = 1 and SK区分 = 0 "   ' And 手配区分 = '2'"       ' 2009.10.23 upd
...
Private Sub Look_Torcd()
    RV_Left = 0
    RV_Top = 0
    RV_TorKb = 7    ' RV_TorKb = 6  ' 2009.10.23 upd
    RV_Call = ""
...
'-----------------------------------------------' 2009.12.24 upd start
'    CKK0035.Show vbModal
'    Unload CKK0035
'    Set CKK0035 = Nothing
    RVI_Tehai = 2
    CKN3235.Show vbModal
    Unload CKN3235
    Set CKN3235 = Nothing
'-----------------------------------------------' 2009.12.24 upd end
...
'        gSL_Select = gSL_Select & "   And 手配区分 = '2'"      ' 2009.10.23 del
...
'        gSL_Select = gSL_Select & "   And HT.手配区分 = '2'"               ' 2009.10.23 del
