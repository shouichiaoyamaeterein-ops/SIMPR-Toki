...
Begin VB.Form CXJ0060 
   ...
   ScaleWidth      =   15330
   WindowState     =   2  '最大化
   Begin Cis3D_v60.CIS3D lb_InputKB 
      Height          =   330
      Left            =   7155
      Top             =   2220
      Width           =   915
      ...
      Begin Cis3D_v60.CIS3D BLB_Back 
         ...
         Begin Cis3D_v60.CIS3D BLB_Back 
            ...
            Begin Cis3D_v60.CIS3D BLB_Line 
               ...
               cAlingnment     =   6
               cPositionY      =   30
               Begin Cis3D_v60.CIS3D B1_BodyBack 
                  Height          =   450
                  Index           =   1
                  Left            =   1635
                  Top             =   15
               ...
               Begin Cis3D_v60.CIS3D Body_GNo 
                  ...
                  cPositionY      =   30
               End
               Begin CisText_V60.CisText iB1_Nouban 
                  Height          =   360
                  Index           =   1
                  Left            =   435
                  TabIndex        =   12
...
'**********************************************************'
'**
'**       フォーム名    :   受注画面入力 [単品：多納番/一納番切替機能付]
'**       フォームID    :   CXJ0060
'**       処理概要      :
'**
'**       作  成  日    :   2006/05/15  By CIS SIMPR-A
'**       変　更　日    :   2006/12/19  By CIS  多納番/一納番切替初期画面
'**                         2008/04/09  By CIS 背番号8桁
'**                         2009/09/21  By CIS 土岐津Ver(受入位置変更,出荷管理部署)
'**                         2010/09/17  By CIS 背番号複数存在時の収容数取得修正
'**                         2011/03/22  By CIS 背番号ﾛｽﾄﾌｫｰｶｽ動作変更
'**********************************************************'
    ...
    Dim mCHG_Flg        As Byte         '納入番号入力形態切替フラグ(0:多品 1:一品)
    Dim mI              As Integer
...
Private Function Key_Acc(Key_Code As Integer, IVENT As String, Shift As Integer)
    ...
    Select Case Key_Code
           Case vbKeyF5:        If PB_CHG.Visible Then Call PB_CHG_Click    '【検索】
...
Private Sub PB_CHG_Click()
    If mCHG_Flg = 0 Then
       ...
       H2_Area2.Visible = False
       For mI = 0 To 10
           'B1_BodyBack(mI).Left = 1470                     '2008/04/09
'           B1_BodyBack(mI).Left = 1455                     '2008/04/09
           B1_BodyBack(mI).Left = 1635                     '2010/05/19
           If mI = 0 Then
              'BLB_Title.Width = 9960                     '2008/04/09
              'BLB_Title.Width = 10335                     '2008/04/09
'              BLB_Title.Width = 13155
              BLB_Title.Width = 13155                       '2010/05/20
           Else
              'BLB_Line(mI).Width = 9960                     '2008/04/09
              'BLB_Line(mI).Width = 10335                     '2008/04/09
'              BLB_Line(mI).Width = 13155
              BLB_Line(mI).Width = 13155                    '2010/05/20
           End If
       Next mI
       'BLB_Back(1).Width = 10065                     '2008/04/09
       'BLB_Back(1).Width = 10425                     '2008/04/09
'       BLB_Back(1).Width = 13275
       BLB_Back(1).Width = 13260                        '2010/05/20
       'BLB_Back(0).Width = 10140                     '2008/04/09
       'BLB_Back(0).Width = 10485                     '2008/04/09
'       BLB_Back(0).Width = 13335
       BLB_Back(0).Width = 13320                '2010/05/20
       'B1_Area1.Width = 10335                     '2008/04/09
       'B1_Area1.Width = 10635                     '2008/04/09
       B1_Area1.Width = 13500
    Else
       mCHG_Flg = 0
       lb_InputKB = "多納番"
    
       H2_Area2.Visible = True
       For mI = 0 To 10
           B1_BodyBack(mI).Left = 435
           If mI = 0 Then
              'BLB_Title.Width = 8930                     '2008/04/09
              'BLB_Title.Width = 9280                     '2008/04/09
              BLB_Title.Width = 12100
           Else
              'BLB_Line(mI).Width = 8930                     '2008/04/09
              'BLB_Line(mI).Width = 9280                     '2008/04/09
              BLB_Line(mI).Width = 12100
           End If
       Next mI
       'BLB_Back(1).Width = 9030                     '2008/04/09
       'BLB_Back(1).Width = 9380                     '2008/04/09
       BLB_Back(1).Width = 12200
       'BLB_Back(0).Width = 9105                     '2008/04/09
       'BLB_Back(0).Width = 9485                     '2008/04/09
       BLB_Back(0).Width = 12305
       'B1_Area1.Width = 9300                     '2008/04/09
       'B1_Area1.Width = 9680                     '2008/04/09
       B1_Area1.Width = 12500
    End If
End Sub
'+----------------------------+
'+    検  索  キ ー(F7)       +
...
Private Sub iB1_Hinbn_LostFocus(Index As Integer)
    ...
    End If
'   >> 背番号ｾｯﾄ
    'If RTrim(iB1_Hinbn(Index)) <> "" And RTrim(iB1_Seban(Index)) = "" And RTrim(B1lb_Uke(Index)) = "" And RTrim(B1lb_SyukaK(Index)) = "" Then
    If RTrim(iB1_Hinbn(Index)) <> "" And RTrim(iB1_Seban(Index)) = "" Then
        If SqlSelectHTM(iB1_Hinbn(Index), "") Then
            iB1_Seban(Index) = RTrim(HTM.背番号)
            B1lb_Uke(Index) = RTrim(HTM.受入)
            B1lb_SyukaK(Index) = RTrim(HTM.出荷管理部署)
...
'   >> 品番ｾｯﾄ
    B1lb_Syuyo(Index) = ""
    'If RTrim(iB1_Seban(Index)) <> "" And RTrim(iB1_Hinbn(Index)) = "" And RTrim(B1lb_Uke(Index)) = "" And RTrim(B1lb_SyukaK(Index)) <> "" Then

'   2011/03/22 Start
'    If RTrim(iB1_Seban(Index)) <> "" And RTrim(iB1_Hinbn(Index)) = "" Then
...
'    lb_InputKB.Visible = H2Mode

    If ProcHB = "B1" Then
       If mCHG_Flg = 0 Then
          For mI = 1 To 10
              iB1_Nouban(mI).Enabled = False
          Next mI
       Else
          For mI = 1 To 10
              iB1_Nouban(mI).Enabled = True
          Next mI
       End If
    End If
' ﾀﾞﾐｰ項目(入力禁止)
    ...
    For wIndex = 1 To 10
        If RTrim(iB1_Hinbn(wIndex)) <> "" Or _
           RTrim(iB1_Seban(wIndex)) <> "" Then
            wInput = True
'           >> 品番入力、背番号未入力時
            If RTrim(iB1_Hinbn(wIndex)) <> "" And RTrim(iB1_Seban(wIndex)) = "" And RTrim(B1lb_Uke(wIndex)) = "" Then
                If SqlSelectHTM(iB1_Hinbn(wIndex), "") Then
                    iB1_Seban(wIndex) = RTrim(HTM.背番号)
                    B1lb_Uke(wIndex) = RTrim(HTM.受入)
                    B1lb_SyukaK(wIndex) = RTrim(HTM.出荷管理部署)
...
'           << 品番 >>
            ...
            Else
                If Not SqlSelectHNM(iB1_Hinbn(wIndex)) Then
                    ...
                    Exit Function
                End If
                If Not SqlSelectHTM_Chk(iB1_Hinbn(wIndex), "", B1lb_Uke(wIndex)) Then
            ...
            End If
        ' 背番号半角チェック
            If RTrim(iB1_Seban(wIndex)) <> "" And Not HalfSizeChk(RTrim(iB1_Seban(wIndex))) Then
                With CisFun
                     .MB_Lines = 4
        ...
        ' 納入番号チェック
            If mCHG_Flg = 0 Then
               ...
               End If
            Else
               If RTrim(iB1_Nouban(wIndex)) = "" Then
                  With CisFun
                       .MB_Lines = 4
                       .MB_MSG(2) = "    納入番号を入力して下さい            "
                       .MB_Title = ""
                       .MB_Button = Error
                       .MBOX
                  End With
                  iB1_Nouban(wIndex).SetFocus
                  Exit Function
               End If
            End If
...
'           << 納入番号重複チェック >>
            If mCHG_Flg = 1 Then
               For gIndex = wIndex + 1 To 10
                   If RTrim(iB1_Nouban(wIndex)) = RTrim(iB1_Nouban(gIndex)) Then
                       CisFun.MB_MSG(1) = "    納入番号が重複しています。            "
                       CisFun.MB_MSG(3) = "    " & wIndex & "行目と " & gIndex & "行目            "
                       CisFun.MBOX
                       iB1_Nouban(wIndex).SetFocus
                       Exit Function
...
'           << 収容数 <= 端数 >>
            ...
            If mCHG_Flg = 1 Then
               If Not Daburi11_Check Then
                  CisFun.MB_MSG(1) = "    " & wI & "行目"
                  CisFun.MB_MSG(3) = "【納入日・納入番号・品番】既にデータが存在します"
                  CisFun.MBOX
                  iB1_Nouban(wIndex).SetFocus
                  Exit Function
               End If
...
' ( 確認メッセージ )
    With CisFun
        ...
        .MB_MSG(5) = "    納番 ＝ " & StrConv(iH2_Nouban, vbWide)
        .MB_Title = "追加処理"
        .MB_Button = OK_CAN
...
Public Function SqlSelectHTM(Hinbn As String, Seban As String, Optional DBNo As Integer = 0) As Boolean
    ...
    gSL_Select = ""
    gSL_Select = gSL_Select & "select ht.品番"
    gSL_Select = gSL_Select & "     , ht.背番号"
'    gSL_Select = gSL_Select & "     , ht.収容数1"
    gSL_Select = gSL_Select & "     , ht.収容数2"
'===================== 2010/09/17 Start
    gSL_Select = gSL_Select & "     , case when 変更日 <> '' and 変更日 + 変更便 <= ' " & RTrim(iH2_Ymd) & RTrim(iH2_Bin) & "'"
    gSL_Select = gSL_Select & "         then 収容数2 else 収容数1 end 収容数1 "
'===================== 2010/09/17 End
    gSL_Select = gSL_Select & "     , ht.変更日"
    gSL_Select = gSL_Select & "     , ht.変更便"
    gSL_Select = gSL_Select & "     , ht.伝票種類"
    gSL_Select = gSL_Select & "     , isnull(tr.正式名称,'') 取引先名"
    gSL_Select = gSL_Select & "     , ht.取引先"
    gSL_Select = gSL_Select & "     , ht.受入"
    gSL_Select = gSL_Select & "     , ht.出荷管理部署"
    gSL_Select = gSL_Select & "     , isnull(tr1.正式名称,'') 出荷管理部署名"
    gSL_Select = gSL_Select & "  from 品番取引先マスタ ht"
    gSL_Select = gSL_Select & "  left outer join 取引先マスタ tr "
    gSL_Select = gSL_Select & "  on  tr.取引先CD = '" & RTrim(iH2_Torcd) & "'"
    gSL_Select = gSL_Select & "  and tr.取引先区分 = 0 "
    gSL_Select = gSL_Select & "  left outer join 取引先マスタ tr1 "
    gSL_Select = gSL_Select & "  on  tr1.取引先CD = ht.出荷管理部署 "
    gSL_Select = gSL_Select & "  and tr1.取引先区分 = 1 "
    gSL_Select = gSL_Select & "  and tr1.社内区分 = 1 "
'   >> 条件ｾｯﾄ開始
    If RTrim(Hinbn) <> "" Then
        gSL_Select = gSL_Select & " where ht.品番 = '" & RTrim(Hinbn) & "'"
    Else
        gSL_Select = gSL_Select & " where ht.背番号 = '" & RTrim(Seban) & "'"
    End If
'   >> 条件ｾｯﾄ終了
    gSL_Select = gSL_Select & "   and ht.取引先 = '" & RTrim(iH2_Torcd) & "'"
        ...
        Else
           If CisDB.RecordCount >= 2 Then
              ...
              If RV_Rtn Then
                 ...
                 HTM.背番号 = RV_Seban
                 HTM.受入 = RV_Ukeir
                 HTM.出荷管理部署 = RV_STorcd
                 
                 HTM.収容数1 = RV_Su1               '2010/09/17
...
'+      品番取引先マスタ索引
'+---------------------------------------+
Public Function SqlSelectHTM_Chk(Hinbn As String, Seban As String, Uke As String, Optional DBNo As Integer = 0) As Boolean
    SqlSelectHTM_Chk = False
...
'   >> 条件ｾｯﾄ終了
    gSL_Select = gSL_Select & "   and ht.取引先 = '" & RTrim(iH2_Torcd) & "'"
    gSL_Select = gSL_Select & "   and 受入 = '" & RTrim(Uke) & "'"
    gSL_Select = gSL_Select & "   and ht.品目 = 0"

    If HTMRead(gSL_Select, , DBNo) Then
        If CisDB.RecordCount = 1 Then
           SqlSelectHTM_Chk = True
        End If
    End If
...
'******************************************************************
'*
'*      受注入力ワーク＆受注テーブル　重複チェック(１品１葉）
'*
'******************************************************************
Private Function Daburi11_Check() As Boolean
    Daburi11_Check = False

    gStr1 = ""
    gStr2 = ""
    
    For wI = 1 To 10
        If RTrim(iB1_Hinbn(wI)) <> "" Or _
           RTrim(iB1_Seban(wI)) <> "" Or _
           CisFun.Val2(iB1_MaiSu(wI)) <> 0 Or _
           CisFun.Val2(iB1_HaSu(wI)) <> 0 Or _
           CisFun.Val2(iB1_JyuSu(wI)) <> 0 Then
            ...
            gSL_Select = gSL_Select & "   and jnw.納入日 = '" & RTrim(iH2_Ymd) & "'"
            gSL_Select = gSL_Select & "   and jnw.納入便 = '" & RTrim(iH2_Bin) & "'"
            gSL_Select = gSL_Select & "   and jnw.納入番号 = '" & RTrim(iB1_Nouban(wI)) & "'"
            gSL_Select = gSL_Select & "   and jnw.品番 = '" & RTrim(iB1_Hinbn(wI)) & "'"
            gSL_Select = gSL_Select & " union all "
            gSL_Select = gSL_Select & "select"
            gSL_Select = gSL_Select & "  jyt.受注区分"
            gSL_Select = gSL_Select & ", jyt.受注日"
            ...
            gSL_Select = gSL_Select & "   and jyt.納入日 = '" & RTrim(iH2_Ymd) & "'"
            gSL_Select = gSL_Select & "   and jyt.納入便 = '" & RTrim(iH2_Bin) & "'"
            gSL_Select = gSL_Select & "   and jyt.納入番号 = '" & RTrim(iB1_Nouban(wI)) & "'"
            gSL_Select = gSL_Select & "   and jyt.品番 = '" & RTrim(iB1_Hinbn(wI)) & "'"
