...
'   ( ３ヶ月　月量データ ) < 納期:｢00000000｣/当月数量、 ｢00000001｣/翌月数量、 ｢00000002｣/翌々月数量 >
    gSL_Select = "SELECT  HJ.品番, HJ.手配先, '0000000' +" & vbCrLf
    ...
    gSL_Select = gSL_Select & " AND   TR.取引先区分 = 1 AND TR.契約先区分 = 0 AND TR.社内区分 = 1" & vbCrLf
    gSL_Select = gSL_Select & " GROUP BY HJ.手配先, 背番号, HJ.品番, HJ.計画年月, HJ.内示年月" & vbCrLf

'   ( 読み込み順 )
    gSL_Select = gSL_Select & " ORDER BY HJ.手配先, HJ.品番,  背番号,納期" & vbCrLf
