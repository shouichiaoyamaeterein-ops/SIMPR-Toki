...
'   #------------------#
    ...
    If kn_Call = "" Then
        Select Case App.Title
            ...
            Case "PKNZ0220":  kn_PrtKB = 2
            Case Else
                 kn_PrtKB = 0
        End Select
    End If
    lb_msg = "材料かんばんの発行を行います"
'    Head = "【 材料かんばん 発行 】"
...
Private Sub PB_Kanban_Click()
    ...
    CKNZ0225.Show vbModal
    Unload CKNZ0225
    Set CKNZ0225 = Nothing
...
Private Function Head1Chk() As Boolean
    ...
    gSL_Select = gSL_Select & " Order By 発行種類,取引先,受入,材料管理番号,背番号,収容区分,発行NO"
