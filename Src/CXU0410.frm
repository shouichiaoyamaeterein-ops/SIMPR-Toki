...
' 表示条件 セット
    With CisFun
        ...
        If Trim(iH1_EYM) <> "" Then
           ...
           Else
               .Where_Create AlphaMe, "UJ.実績年月", iH1_SYM, Between, , iH1_EYM
           End If
        Else
          .Where_Create AlphaMe, "UJ.実績年月", iH1_SYM
        End If
    ...
    gSL_Select = gSL_Select & " From 売上実績テーブル UJ"
